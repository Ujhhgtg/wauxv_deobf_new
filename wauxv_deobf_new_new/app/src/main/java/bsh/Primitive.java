...
public final class Primitive implements Serializable {
    ...
    static {
        ...
        NULL = new Primitive(EnumC2446.f7799);
        VOID = new Primitive(EnumC2446.f7800);
    ...
    private Primitive(Object obj) {
        if (obj == null) {
            throw new C1684("Use Primitve.NULL instead of Primitive(null)");
        }
        this.value = obj;
    }
    ...
    public static Class<?> boxType(Class<?> cls) {
        ...
        if (cls2 == null || cls2.isPrimitive()) {
            throw new C1684(AbstractC1095.m2797(cls, "Not a primitive type: "));
        }
        return cls2;
    }
    ...
    public static Object castNumber(Class<?> cls, Number number) {
        ...
        if (dDoubleValue == 0.0d) {
            ...
            if (cls == BigDecimal.class) {
                ...
                return AbstractC0017.m570(number) ? BigDecimal.valueOf(number.doubleValue()) : new BigDecimal(number.longValue()).setScale(1);
            }
            if (number instanceof BigInteger) {
                ...
                bigInteger = AbstractC0017.m570(number) ? BigDecimal.valueOf(number.doubleValue()).toBigInteger() : BigInteger.valueOf(number.longValue());
            }
        ...
        throw new C1684("cannot assign number " + number + " to type " + cls.getSimpleName());
    }
    ...
    public static Primitive castPrimitive(Class<?> cls, Class<?> cls2, Primitive primitive, boolean z, int i) throws C3581 {
        if (cls2 == Void.TYPE) {
            if (z) {
                return AbstractC0017.f576;
            }
            throw AbstractC0017.m558(AbstractC2240.m4267(cls), "void value", null, i);
        }
        if (!z && primitive.isNumber() && AbstractC0017.m574(cls)) {
            return new Primitive(castNumber(cls, primitive.numberValue()));
        }
        if (!cls.isPrimitive()) {
            if (cls2 == null) {
                return z ? AbstractC0017.f575 : NULL;
            }
            if (z) {
                return AbstractC0017.f576;
            }
            throw AbstractC0017.m558("object type ".concat(cls.getName()), "primitive value", null, i);
        }
        if (cls2 == null && !VOID.equals(primitive)) {
            return z ? AbstractC0017.f575 : getDefaultValue(cls);
        }
        Class<?> cls3 = Boolean.TYPE;
        if (cls == cls3) {
            return z ? AbstractC0017.f575 : new Primitive(castWrapper(cls, primitive));
        }
        if (z && cls2 == cls3) {
            return cls != cls3 ? AbstractC0017.f576 : AbstractC0017.f575;
        }
        if (i != 1 || AbstractC0017.m572(cls, cls2) || AbstractC0017.m573(cls, cls2) || !z) {
            return z ? AbstractC0017.f575 : new Primitive(castWrapper(cls, primitive));
        }
        return AbstractC0017.f576;
    }
    ...
    public static Object castWrapper(Class<?> cls, Object obj) {
        ...
        if (!isWrapperType(cls) && !cls.isPrimitive()) {
            throw new C1684(AbstractC1095.m2797(cls, "invalid type in castWrapper: "));
        }
        ...
        if (objUnwrap instanceof String) {
            try {
                ...
                throw new C1684("cannot cast string \"" + objUnwrap + "\" to number", e);
            }
        }
        if (objUnwrap instanceof Boolean) {
        ...
        sb.append(AbstractC2240.m4269(objUnwrap) + " :" + AbstractC2240.m4268(objUnwrap));
        throw new C1684(sb.toString());
    }
    ...
    private Object readResolve() {
        return this.value == EnumC2446.f7799 ? NULL : this;
    }

    public static Primitive shrinkWrap(Object obj) {
        if (!(obj instanceof Number)) {
            throw new C1684("Can only shrink wrap Number types");
        }
        Number number = (Number) obj;
        if (AbstractC0017.m570(obj)) {
    ...
    public static Class<?> unboxType(Class<?> cls) {
        ...
        if (cls2 == null || !(cls2.isPrimitive() || cls2 == cls)) {
            throw new C1684(AbstractC1095.m2797(cls, "Not a primitive wrapper type: "));
        }
        return cls2;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (AbstractC0017.m570(this.value) || AbstractC0017.m570(primitive.value)) {
    ...
    public Object getValue() {
        ...
        if (obj == EnumC2446.f7799) {
            return null;
        }
        if (obj != EnumC2446.f7800) {
            return obj;
        }
        throw new C1684("attempt to unwrap void type");
    }
    ...
    public boolean isNumber() {
        Object obj = this.value;
        return ((obj instanceof Boolean) || this == NULL || this == VOID || !AbstractC0017.m575(obj)) ? false : true;
    }
    ...
    public Number numberValue() {
        ...
        throw new C1684("Primitive not a number");
    }
    ...
    public String toString() {
        ...
        return obj == EnumC2446.f7800 ? "void" : obj.toString();
    }
