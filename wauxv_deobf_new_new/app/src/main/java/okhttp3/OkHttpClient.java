...
public class OkHttpClient implements Cloneable, Call.Factory, WebSocket.Factory {
    ...
    public static final class Builder {
        ...
        public final Builder m1020addInterceptor(final InterfaceC1433 interfaceC1433) {
            return addInterceptor(new Interceptor() { // from class: okhttp3.OkHttpClient$Builder$addInterceptor$2
                @Override // okhttp3.Interceptor
                public final Response intercept(Interceptor.Chain chain) {
                    return (Response) interfaceC1433.invoke(chain);
                }
            });
        }

        /* JADX INFO: renamed from: -addNetworkInterceptor, reason: not valid java name */
        public final Builder m1021addNetworkInterceptor(final InterfaceC1433 interfaceC1433) {
        ...
        public final Builder minWebSocketMessageToCompress(long j) {
            if (j < 0) {
                throw new IllegalArgumentException(AbstractC2844.m4780(j, "minWebSocketMessageToCompress must be positive: ").toString());
            }
        ...
        public final Builder proxy(Proxy proxy) {
            if (!AbstractC1469.m3322(proxy, this.proxy)) {
                this.routeDatabase = null;
            }
            this.proxy = proxy;
            return this;
        ...
        public final Builder sslSocketFactory(SSLSocketFactory sSLSocketFactory) throws IllegalAccessException, ClassNotFoundException {
        ...
        public Builder(OkHttpClient okHttpClient) {
            ...
            AbstractC0745.m2316(this.interceptors, okHttpClient.interceptors());
            AbstractC0745.m2316(this.networkInterceptors, okHttpClient.networkInterceptors());
