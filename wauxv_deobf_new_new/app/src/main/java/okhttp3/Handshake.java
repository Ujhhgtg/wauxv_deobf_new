...
public final class Handshake {
    ...
    private final InterfaceC1780 peerCertificates$delegate;
    ...
    public static final class Companion {
        ...
        private final List<Certificate> toImmutableList(Certificate[] certificateArr) {
            return certificateArr != null ? Util.immutableListOf(Arrays.copyOf(certificateArr, certificateArr.length)) : C1191.f4326;
        }

        /* JADX INFO: renamed from: -deprecated_get, reason: not valid java name */
        public final Handshake m957deprecated_get(SSLSession sSLSession) {
    ...
    public static final class AnonymousClass2 extends AbstractC1778 implements InterfaceC1422 {
        final /* synthetic */ InterfaceC1422 $peerCertificatesFn;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public AnonymousClass2(InterfaceC1422 interfaceC1422) {
            super(0);
            this.$peerCertificatesFn = interfaceC1422;
        }
    ...
    public Handshake(TlsVersion tlsVersion, CipherSuite cipherSuite, List<? extends Certificate> list, InterfaceC1422 interfaceC1422) {
        this.tlsVersion = tlsVersion;
        this.cipherSuite = cipherSuite;
        this.localCertificates = list;
        this.peerCertificates$delegate = new C2933(new AnonymousClass2(interfaceC1422));
    }
    ...
    public boolean equals(Object obj) {
        ...
        return handshake.tlsVersion == this.tlsVersion && AbstractC1469.m3322(handshake.cipherSuite, this.cipherSuite) && AbstractC1469.m3322(handshake.peerCertificates(), peerCertificates()) && AbstractC1469.m3322(handshake.localCertificates, this.localCertificates);
    }
    ...
    public final Principal localPrincipal() {
        Object objM2291 = AbstractC0739.m2291(this.localCertificates);
        X509Certificate x509Certificate = objM2291 instanceof X509Certificate ? (X509Certificate) objM2291 : null;
    ...
    public final Principal peerPrincipal() {
        Object objM2291 = AbstractC0739.m2291(peerCertificates());
        X509Certificate x509Certificate = objM2291 instanceof X509Certificate ? (X509Certificate) objM2291 : null;
        if (x509Certificate != null) {
            return x509Certificate.getSubjectX500Principal();
        }
