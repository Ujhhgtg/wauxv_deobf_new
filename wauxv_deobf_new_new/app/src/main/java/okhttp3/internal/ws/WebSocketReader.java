...
public final class WebSocketReader implements Closeable {
    ...
    private final C0481 controlFrameBuffer = new C0481();
    private final C0481 messageFrameBuffer = new C0481();
    ...
    public interface FrameCallback {
        ...
        void onReadMessage(C0516 c0516);

        void onReadPing(C0516 c0516);

        void onReadPong(C0516 c0516);
    }

    public WebSocketReader(boolean z, InterfaceC0485 interfaceC0485, FrameCallback frameCallback, boolean z2, boolean z3) {
        this.isClient = z;
        ...
        this.maskCursor = z ? null : new C0479();
    }
    ...
    private final void readControlFrame() throws ProtocolException, EOFException {
        ...
        if (j > 0) {
            this.source.mo1870(this.controlFrameBuffer, j);
            if (!this.isClient) {
                this.controlFrameBuffer.m1876(this.maskCursor);
        ...
        switch (this.opcode) {
            case 8:
                C0481 c0481 = this.controlFrameBuffer;
                long j2 = c0481.f2128;
                if (j2 == 1) {
                ...
                if (j2 != 0) {
                    s = c0481.readShort();
                    strM1880 = this.controlFrameBuffer.m1880();
                ...
                this.frameCallback.onReadClose(s, strM1880);
                this.closed = true;
                return;
            case 9:
                FrameCallback frameCallback = this.frameCallback;
                C0481 c0482 = this.controlFrameBuffer;
                frameCallback.onReadPing(c0482.mo1856(c0482.f2128));
                return;
            case 10:
                FrameCallback frameCallback2 = this.frameCallback;
                C0481 c0483 = this.controlFrameBuffer;
                frameCallback2.onReadPong(c0483.mo1856(c0483.f2128));
                return;
            default:
    ...
    private final void readMessage() throws IOException {
        while (!this.closed) {
            long j = this.frameLength;
            if (j > 0) {
                this.source.mo1870(this.messageFrameBuffer, j);
                if (!this.isClient) {
                    this.messageFrameBuffer.m1876(this.maskCursor);
                    this.maskCursor.m1852(this.messageFrameBuffer.f2128 - this.frameLength);
                    WebSocketProtocol.INSTANCE.toggleMask(this.maskCursor, this.maskKey);
                    this.maskCursor.close();
                }
            }
    ...
    private final void readMessageFrame() throws IOException {
        ...
        if (i == 1) {
            this.frameCallback.onReadMessage(this.messageFrameBuffer.m1880());
            return;
        }
        FrameCallback frameCallback = this.frameCallback;
        C0481 c0481 = this.messageFrameBuffer;
        frameCallback.onReadMessage(c0481.mo1856(c0481.f2128));
    }
