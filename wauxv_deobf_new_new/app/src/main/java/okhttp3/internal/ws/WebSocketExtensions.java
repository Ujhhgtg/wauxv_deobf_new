...
public final class WebSocketExtensions {
    ...
    public static final class Companion {
        ...
        public final WebSocketExtensions parse(Headers headers) {
            ...
            boolean z = false;
            Integer numM4914 = null;
            boolean z2 = false;
            Integer numM4915 = null;
            boolean z3 = false;
            boolean z4 = false;
            for (int i = 0; i < size; i++) {
                if (AbstractC2909.m4916(headers.name(i), WebSocketExtensions.HEADER_WEB_SOCKET_EXTENSION)) {
                    ...
                    while (i2 < strValue.length()) {
                        ...
                        if (AbstractC2909.m4916(strTrimSubstring2, "permessage-deflate")) {
                            if (z) {
                                z4 = true;
                            }
                            i2 = i3;
                            while (i2 < iDelimiterOffset$default) {
                                ...
                                if (iDelimiterOffset3 < iDelimiterOffset2) {
                                    ...
                                    if (strTrimSubstring.length() >= 2 && strTrimSubstring.startsWith("\"") && strTrimSubstring.endsWith("\"")) {
                                        strTrimSubstring = AbstractC2844.m4778(1, 1, strTrimSubstring);
                                    }
                                } else {
                                    strTrimSubstring = null;
                                }
                                int i4 = iDelimiterOffset2 + 1;
                                if (AbstractC2909.m4916(strTrimSubstring3, "client_max_window_bits")) {
                                    if (numM4914 != null) {
                                        z4 = true;
                                    }
                                    numM4914 = strTrimSubstring != null ? AbstractC2908.m4914(strTrimSubstring) : null;
                                    if (numM4914 == null) {
                                        z4 = true;
                                    }
                                } else if (AbstractC2909.m4916(strTrimSubstring3, "client_no_context_takeover")) {
                                    if (z2) {
                                        z4 = true;
                                    }
                                    ...
                                    z2 = true;
                                } else if (AbstractC2909.m4916(strTrimSubstring3, "server_max_window_bits")) {
                                    if (numM4915 != null) {
                                        z4 = true;
                                    }
                                    numM4915 = strTrimSubstring != null ? AbstractC2908.m4914(strTrimSubstring) : null;
                                    if (numM4915 == null) {
                                        z4 = true;
                                    }
                                } else if (AbstractC2909.m4916(strTrimSubstring3, "server_no_context_takeover")) {
                                    if (z3) {
                                        z4 = true;
                                    }
                                    if (strTrimSubstring != null) {
            ...
            return new WebSocketExtensions(z, numM4914, z2, numM4915, z3, z4);
        }
    ...
    public boolean equals(Object obj) {
        ...
        return this.perMessageDeflate == webSocketExtensions.perMessageDeflate && AbstractC1469.m3322(this.clientMaxWindowBits, webSocketExtensions.clientMaxWindowBits) && this.clientNoContextTakeover == webSocketExtensions.clientNoContextTakeover && AbstractC1469.m3322(this.serverMaxWindowBits, webSocketExtensions.serverMaxWindowBits) && this.serverNoContextTakeover == webSocketExtensions.serverNoContextTakeover && this.unknownValues == webSocketExtensions.unknownValues;
    }
    ...
    public /* synthetic */ WebSocketExtensions(boolean z, Integer num, boolean z2, Integer num2, boolean z3, boolean z4, int i, AbstractC0985 abstractC0985) {
