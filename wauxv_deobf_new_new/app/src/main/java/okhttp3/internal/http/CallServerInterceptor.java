            ...
            if (!HttpMethod.permitsRequestBody(request$okhttp.method()) || requestBodyBody == null) {
                ...
                try {
                    if (responseHeaders != null) {
                        ...
                        exchange$okhttp.flushRequest();
                        requestBodyBody.writeTo(new C2530(exchange$okhttp.createRequestBody(request$okhttp, true)));
                    } else {
                        C2530 c2530 = new C2530(exchange$okhttp.createRequestBody(request$okhttp, false));
                        requestBodyBody.writeTo(c2530);
                        c2530.close();
                    }
                    z2 = z;
