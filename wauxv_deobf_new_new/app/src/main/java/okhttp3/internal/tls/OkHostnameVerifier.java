...
public final class OkHostnameVerifier implements HostnameVerifier {
    ...
    private final List<String> getSubjectAltNames(X509Certificate x509Certificate, int i) {
        ...
        try {
            ...
            for (List<?> list : subjectAlternativeNames) {
                if (list != null && list.size() >= 2 && AbstractC1469.m3322(list.get(0), Integer.valueOf(i)) && (obj = list.get(1)) != null) {
    ...
    private final boolean isAscii(String str) {
        ...
        if (length2 < 0) {
            throw new IllegalArgumentException(AbstractC2844.m4779(length2, "endIndex < beginIndex: ", " < ", 0).toString());
        }
        if (length2 > str.length()) {
            StringBuilder sbM2802 = AbstractC1095.m2802(length2, "endIndex > string.length: ", " > ");
    ...
    private final boolean verifyIpAddress(String str, X509Certificate x509Certificate) {
        ...
        Iterator<T> it = subjectAltNames.iterator();
        while (it.hasNext()) {
            if (AbstractC1469.m3322(canonicalHost, HostnamesKt.toCanonicalHost((String) it.next()))) {
                return true;
            }
        }
        return false;
    ...
    public final List<String> allSubjectAltNames(X509Certificate x509Certificate) {
        return AbstractC0739.m2297(getSubjectAltNames(x509Certificate, 7), getSubjectAltNames(x509Certificate, 2));
    }
    ...
    private final boolean verifyHostname(String str, String str2) {
        ...
        if (str != null && str.length() != 0 && !str.startsWith(".") && !str.endsWith("..") && str2 != null && str2.length() != 0 && !str2.startsWith(".") && !str2.endsWith("..")) {
            ...
            if (!AbstractC2901.m4861(strAsciiToLowercase, "*", false)) {
                return AbstractC1469.m3322(str, strAsciiToLowercase);
            }
            if (strAsciiToLowercase.startsWith("*.") && AbstractC2901.m4866('*', 1, 4, strAsciiToLowercase) == -1 && str.length() >= strAsciiToLowercase.length() && !"*.".equals(strAsciiToLowercase)) {
                String strSubstring = strAsciiToLowercase.substring(1);
                if (str.endsWith(strSubstring) && ((length = str.length() - strSubstring.length()) <= 0 || AbstractC2901.m4871(str, '.', length - 1, 4) == -1)) {
                    return true;
                }
            }
        }
