...
public final class Http2Writer implements Closeable {
    ...
    private final C0481 hpackBuffer;
    ...
    public Http2Writer(InterfaceC0484 interfaceC0484, boolean z) {
        this.sink = interfaceC0484;
        this.client = z;
        C0481 c0481 = new C0481();
        this.hpackBuffer = c0481;
        this.maxFrameSize = Http2.INITIAL_MAX_FRAME_SIZE;
        this.hpackWriter = new Hpack.Writer(0, false, c0481, 3, null);
    }
        ...
        try {
            ...
            if (this.client) {
                ...
                if (logger2.isLoggable(Level.FINE)) {
                    logger2.fine(Util.format(">> CONNECTION " + Http2.CONNECTION_PREFACE.mo1965(), new Object[0]));
                }
                this.sink.mo1871(Http2.CONNECTION_PREFACE);
                this.sink.flush();
            }
        } catch (Throwable th) {
            throw th;
    ...
    public final synchronized void data(boolean z, int i, C0481 c0481, int i2) {
        if (this.closed) {
            throw new IOException("closed");
        }
        dataFrame(i, z ? 1 : 0, c0481, i2);
    }

    public final void dataFrame(int i, int i2, C0481 c0481, int i3) {
        frameHeader(i, i3, 0, i2);
        if (i3 > 0) {
            this.sink.write(c0481, i3);
        }
    }
    ...
    public final void frameHeader(int i, int i2, int i3, int i4) {
        ...
        if ((Integer.MIN_VALUE & i5) != 0) {
            throw new IllegalArgumentException(AbstractC1095.m2794(i5, "reserved bit set: ").toString());
        }
