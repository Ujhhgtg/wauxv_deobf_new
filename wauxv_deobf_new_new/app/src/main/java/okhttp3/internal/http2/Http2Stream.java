...
public final class Http2Stream {
    ...
    /* JADX INFO: compiled from: obf */
    public final class FramingSource implements InterfaceC2846 {
        private boolean closed;
        private boolean finished;
        private final long maxByteCount;
        private Headers trailers;
        private final C0481 receiveBuffer = new C0481();
        private final C0481 readBuffer = new C0481();
        ...
        public final C0481 getReadBuffer() {
            return this.readBuffer;
        }

        public final C0481 getReceiveBuffer() {
            ...
            while (true) {
                ...
                synchronized (http2Stream) {
                    ...
                    try {
                        ...
                        C0481 c0482 = this.readBuffer;
                        long j4 = c0482.f2128;
                        z = false;
                        if (j4 > j3) {
                            j2 = c0482.read(c0481, Math.min(j, j4));
        ...
        public final void receive$okhttp(InterfaceC0485 interfaceC0485, long j) throws EOFException {
            boolean z;
            boolean z2;
            Http2Stream http2Stream = Http2Stream.this;
            if (Util.assertionsEnabled && Thread.holdsLock(http2Stream)) {
            ...
            while (j2 > 0) {
                synchronized (Http2Stream.this) {
                    z = this.finished;
                    z2 = this.readBuffer.f2128 + j2 > this.maxByteCount;
                }
                if (z2) {
                    interfaceC0485.skip(j2);
                ...
                long j3 = interfaceC0485.read(this.receiveBuffer, j2);
                if (j3 == -1) {
                ...
                synchronized (http2Stream2) {
                    try {
                        if (this.closed) {
                            this.receiveBuffer.m1855();
                        } else {
                            C0481 c0481 = this.readBuffer;
                            boolean z3 = c0481.f2128 == 0;
                            c0481.mo1863(this.receiveBuffer);
                            if (z3) {
    ...
    /* JADX INFO: compiled from: obf */
    public final class StreamTimeout extends C0290 {
    ...
    public final InterfaceC2774 getSink() {
        synchronized (this) {
    ...
    public final InterfaceC2846 getSource() {
        return this.source;
    }
    ...
    public final C3459 readTimeout() {
        return this.readTimeout;
    }

    public final void receiveData(InterfaceC0485 interfaceC0485, int i) {
        if (!Util.assertionsEnabled || !Thread.holdsLock(this)) {
            this.source.receive$okhttp(interfaceC0485, i);
            return;
        }
        throw new AssertionError("Thread " + Thread.currentThread().getName() + " MUST NOT hold lock on " + this);
    }
    ...
    public final synchronized Headers trailers() throws IOException {
        Headers trailers;
        if (!this.source.getFinished$okhttp() || !this.source.getReceiveBuffer().mo1860() || !this.source.getReadBuffer().mo1860()) {
            if (this.errorCode == null) {
    ...
    public final C3459 writeTimeout() {
        return this.writeTimeout;
    }

    /* JADX INFO: compiled from: obf */
    public final class FramingSink implements InterfaceC2774 {
        private boolean closed;
        private boolean finished;
        private final C0481 sendBuffer;
        private Headers trailers;

        public FramingSink(boolean z) {
            this.finished = z;
            this.sendBuffer = new C0481();
        }
        ...
        private final void emitFrame(boolean z) throws IOException {
            ...
            synchronized (http2Stream) {
                ...
                jMin = Math.min(http2Stream.getWriteBytesMaximum() - http2Stream.getWriteBytesTotal(), this.sendBuffer.f2128);
                http2Stream.setWriteBytesTotal$okhttp(http2Stream.getWriteBytesTotal() + jMin);
                z2 = z && jMin == this.sendBuffer.f2128;
            }
        ...
        public void close() throws IOException {
            ...
            synchronized (http2Stream2) {
                ...
                if (!Http2Stream.this.getSink$okhttp().finished) {
                    boolean z2 = this.sendBuffer.f2128 > 0;
                    if (this.trailers != null) {
                        while (this.sendBuffer.f2128 > 0) {
                            emitFrame(false);
                        }
        ...
        @Override // p000.InterfaceC2774
        public void write(C0481 c0481, long j) throws IOException {
            Http2Stream http2Stream = Http2Stream.this;
            if (!Util.assertionsEnabled || !Thread.holdsLock(http2Stream)) {
                this.sendBuffer.write(c0481, j);
                while (this.sendBuffer.f2128 >= 16384) {
                    emitFrame(false);
                }
            } else {
                throw new AssertionError("Thread " + Thread.currentThread().getName() + " MUST NOT hold lock on " + http2Stream);
        ...
        public /* synthetic */ FramingSink(Http2Stream http2Stream, boolean z, int i, AbstractC0985 abstractC0985) {
            this((i & 1) != 0 ? false : z);
        }
    }
}
