...
public class Platform {
    ...
    public static final class Companion {
        ...
        public final byte[] concatLengthPrefixed(List<? extends Protocol> list) {
            ...
            for (String str : alpnProtocolNames(list)) {
                c0481.m1890(str.length());
                c0481.m1897(0, str.length(), str);
            }
    ...
    public X509TrustManager trustManager(SSLSocketFactory sSLSocketFactory) throws IllegalAccessException, ClassNotFoundException {
        try {
