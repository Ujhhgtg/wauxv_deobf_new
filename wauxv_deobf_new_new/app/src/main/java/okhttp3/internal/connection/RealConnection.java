...
public final class RealConnection extends Http2Connection.Listener implements Connection {
    ...
    private InterfaceC0484 sink;
    private Socket socket;
    private InterfaceC0485 source;
    ...
    /* JADX INFO: compiled from: obf */
    public static final class AnonymousClass2 extends AbstractC1778 implements InterfaceC1422 {
        ...
        public final List<X509Certificate> invoke() {
            ...
            ArrayList arrayList = new ArrayList(AbstractC0741.m2313(listPeerCertificates, 10));
    ...
    private final void connectSocket(int i, int i2, Call call, EventListener eventListener) throws IOException {
        ...
        try {
            ...
            try {
                this.source = new C2531(AbstractC1467.m3291(socketCreateSocket));
                this.sink = new C2530(AbstractC1467.m3289(socketCreateSocket));
            } catch (NullPointerException e) {
                if (AbstractC1469.m3322(e.getMessage(), NPE_THROW_WITH_NULL)) {
        ...
        try {
            ...
            try {
                ...
                if (address.hostnameVerifier().verify(address.url().host(), session)) {
                    ...
                    this.source = new C2531(AbstractC1467.m3291(sSLSocket2));
                    this.sink = new C2530(AbstractC1467.m3289(sSLSocket2));
                ...
                throw new SSLPeerUnverifiedException(AbstractC2902.m4904("\n              |Hostname " + address.url().host() + " not verified:\n              |    certificate: " + CertificatePinner.Companion.pin(x509Certificate) + "\n              |    DN: " + x509Certificate.getSubjectDN().getName() + "\n              |    subjectAltNames: " + OkHostnameVerifier.INSTANCE.allSubjectAltNames(x509Certificate) + "\n              "));
            } catch (Throwable th) {
                th = th;
    ...
    private final Request createTunnel(int i, int i2, Request request, HttpUrl httpUrl) throws IOException {
        ...
        while (true) {
            ...
            Http1ExchangeCodec http1ExchangeCodec = new Http1ExchangeCodec(null, this, interfaceC0485, interfaceC0484);
            TimeUnit timeUnit = TimeUnit.MILLISECONDS;
            interfaceC0485.timeout().timeout(i, timeUnit);
            interfaceC0484.timeout().timeout(i2, timeUnit);
            ...
            if (iCode == 200) {
                if (interfaceC0485.mo1854().mo1860() && interfaceC0484.mo1854().mo1860()) {
                    return null;
                }
    ...
    private final boolean routeMatchesAny(List<Route> list) {
        ...
        for (Route route : list) {
            ...
            if (type == type2 && this.route.proxy().type() == type2 && AbstractC1469.m3322(this.route.socketAddress(), route.socketAddress())) {
                return true;
            }
        }
        return false;
    ...
    private final void startHttp2(int i) throws SocketException {
        ...
        Http2Connection http2ConnectionBuild = new Http2Connection.Builder(true, TaskRunner.INSTANCE).socket(socket, this.route.address().url().host(), interfaceC0485, interfaceC0484).listener(this).pingIntervalMillis(i).build();
    ...
    private final boolean supportsUrl(HttpUrl httpUrl) {
        ...
        if (AbstractC1469.m3322(httpUrl.host(), httpUrlUrl.host())) {
            return true;
        }
    ...
    public final void connect(int i, int i2, int i3, int i4, boolean z, Call call, EventListener eventListener) throws Throwable {
        ...
        if (this.route.address().sslSocketFactory() != null) {
            ...
            if (!zIsCleartextTrafficPermitted) {
                ...
                throw new RouteException(new UnknownServiceException(AbstractC1095.m2800("CLEARTEXT communication to ", strHost, " not permitted by network security policy")));
            }
        }
        r1 = protocol;
        r1 = zIsCleartextTrafficPermitted;
    ...
    public final boolean isEligible$okhttp(Address address, List<Route> list) {
        ...
        if (AbstractC1469.m3322(address.url().host(), route().address().url().host())) {
            return true;
        }
    ...
    public final boolean isHealthy(boolean z) {
        ...
        return Util.isHealthy(socket2, interfaceC0485);
    }
    ...
    public final ExchangeCodec newCodec$okhttp(OkHttpClient okHttpClient, RealInterceptorChain realInterceptorChain) throws SocketException {
        ...
        C3459 c3459Timeout = interfaceC0485.timeout();
        long readTimeoutMillis$okhttp = realInterceptorChain.getReadTimeoutMillis$okhttp();
        TimeUnit timeUnit = TimeUnit.MILLISECONDS;
        c3459Timeout.timeout(readTimeoutMillis$okhttp, timeUnit);
        interfaceC0484.timeout().timeout(realInterceptorChain.getWriteTimeoutMillis$okhttp(), timeUnit);
        return new Http1ExchangeCodec(okHttpClient, this, interfaceC0485, interfaceC0484);
    }

    public final RealWebSocket.Streams newWebSocketStreams$okhttp(final Exchange exchange) throws SocketException {
        Socket socket = this.socket;
        final InterfaceC0485 interfaceC0485 = this.source;
        final InterfaceC0484 interfaceC0484 = this.sink;
        socket.setSoTimeout(0);
        noNewExchanges$okhttp();
        return new RealWebSocket.Streams(interfaceC0485, interfaceC0484) { // from class: okhttp3.internal.connection.RealConnection$newWebSocketStreams$1
