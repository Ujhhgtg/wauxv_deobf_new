...
public final class RealConnectionPool {
    ...
    public RealConnectionPool(TaskRunner taskRunner, int i, long j, TimeUnit timeUnit) {
        ...
        final String strM4786 = AbstractC2844.m4786(new StringBuilder(), Util.okHttpName, " ConnectionPool");
        this.cleanupTask = new Task(strM4786) { // from class: okhttp3.internal.connection.RealConnectionPool$cleanupTask$1
        ...
        if (j <= 0) {
            throw new IllegalArgumentException(AbstractC2844.m4780(j, "keepAliveDuration <= 0: ").toString());
        }
    }
