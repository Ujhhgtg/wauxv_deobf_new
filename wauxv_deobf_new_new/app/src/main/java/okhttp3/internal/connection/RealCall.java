...
public final class RealCall implements Call {
                    ...
                    try {
                        try {
                            ...
                            if (!z) {
                                ...
                                AbstractC1272.m3094(iOException, th);
    ...
    /* JADX WARN: Type inference failed for: r4v5, types: [okhttp3.internal.connection.RealCall$timeout$1, ᛱᛲᛳᛴᛵᛶᛷᲁᲇᤝᲈᛸᲀᤞ] */
    public RealCall(OkHttpClient okHttpClient, Request request, boolean z) {
        ...
        ?? r4 = new C0290() { // from class: okhttp3.internal.connection.RealCall.timeout.1
            @Override // p000.C0290
    ...
    public final Response getResponseWithInterceptorChain$okhttp() {
        ...
        AbstractC0745.m2316(arrayList, this.client.interceptors());
        ...
        if (!this.forWebSocket) {
            AbstractC0745.m2316(arrayList, this.client.networkInterceptors());
        }
    ...
    public final Socket releaseConnectionNoEvents$okhttp() {
        ...
        while (true) {
            ...
            if (AbstractC1469.m3322(it.next().get(), this)) {
                break;
            }
            i++;
        }
