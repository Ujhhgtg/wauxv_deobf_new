...
public final class Exchange {
    ...
    /* JADX INFO: compiled from: obf */
    public final class RequestBodySink extends AbstractC1411 {
        private long bytesReceived;
        private boolean closed;
        private boolean completed;
        private final long contentLength;

        public RequestBodySink(InterfaceC2774 interfaceC2774, long j) {
    ...
    /* JADX INFO: compiled from: obf */
    public final class ResponseBodySource extends AbstractC1412 {
        private long bytesReceived;
        private boolean closed;
        private boolean completed;
        private final long contentLength;
        ...
        public ResponseBodySource(InterfaceC2846 interfaceC2846, long j) {
    ...
    public final InterfaceC2774 createRequestBody(Request request, boolean z) {
        this.isDuplex = z;
    ...
    public final boolean isCoalescedConnection$okhttp() {
        return !AbstractC1469.m3322(this.finder.getAddress$okhttp().url().host(), this.connection.route().address().url().host());
    }
    ...
    public final ResponseBody openResponseBody(Response response) throws IOException {
        try {
            ...
            return new RealResponseBody(strHeader$default, jReportedContentLength, new C2531(new ResponseBodySource(this.codec.openResponseBodySource(response), jReportedContentLength)));
        } catch (IOException e) {
            this.eventListener.responseFailed(this.call, e);
            trackFailure(e);
            throw e;
