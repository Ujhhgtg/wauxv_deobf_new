...
public final class TaskQueue {
    ...
    public static final class AwaitIdleTask extends Task {
        ...
        public AwaitIdleTask() {
            super(AbstractC2844.m4786(new StringBuilder(), Util.okHttpName, " awaitIdle"), false);
    ...
    public static final class AnonymousClass1 extends Task {
        final /* synthetic */ InterfaceC1422 $block;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public AnonymousClass1(String str, boolean z, InterfaceC1422 interfaceC1422) {
            super(str, z);
    ...
    public static final class AnonymousClass2 extends Task {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public AnonymousClass2(String str, InterfaceC1422 interfaceC1422) {
    ...
    public static /* synthetic */ void execute$default(TaskQueue taskQueue, String str, long j, boolean z, InterfaceC1422 interfaceC1422, int i, Object obj) {
        if ((i & 2) != 0) {
            j = 0;
        }
        if ((i & 4) != 0) {
        ...
        taskQueue.schedule(new AnonymousClass1(str, z, interfaceC1422), j);
    }
    ...
    public final void execute(String str, long j, boolean z, InterfaceC1422 interfaceC1422) {
        schedule(new AnonymousClass1(str, z, interfaceC1422), j);
    }
    ...
    public final List<Task> getScheduledTasks() {
        List<Task> listM2305;
        synchronized (this.taskRunner) {
            listM2305 = AbstractC0739.m2305(this.futureTasks);
        }
        return listM2305;
    }
    ...
    public static /* synthetic */ void schedule$default(TaskQueue taskQueue, String str, long j, InterfaceC1422 interfaceC1422, int i, Object obj) {
        if ((i & 2) != 0) {
            j = 0;
        }
        taskQueue.schedule(new AnonymousClass2(str, interfaceC1422), j);
    }

    public final void schedule(String str, long j, InterfaceC1422 interfaceC1422) {
        schedule(new AnonymousClass2(str, interfaceC1422), j);
    }
}
