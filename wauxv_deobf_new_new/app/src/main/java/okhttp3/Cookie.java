...
public final class Cookie {
    ...
    public static final class Builder {
        ...
        public final Builder name(String str) {
            if (!AbstractC1469.m3322(AbstractC2901.m4882(str).toString(), str)) {
        ...
        private final Builder domain(String str, boolean z) {
            ...
            if (canonicalHost == null) {
                throw new IllegalArgumentException(AbstractC2844.m4790("unexpected domain: ", str));
            }
    ...
    public static final class Companion {
        ...
        public final boolean domainMatch(String str, String str2) {
            return AbstractC1469.m3322(str, str2) || (str.endsWith(str2) && str.charAt((str.length() - str2.length()) - 1) == '.' && !Util.canParseAsIpAddress(str));
        }
        ...
        private final long parseExpires(String str, int i, int i2) {
            ...
            while (iDateCharacterOffset < i2) {
                ...
                } else if (iM4867 == -1 && matcher.usePattern(Cookie.MONTH_PATTERN).matches()) {
                    iM4867 = AbstractC2901.m4867(Cookie.MONTH_PATTERN.pattern(), matcher.group(1).toLowerCase(Locale.US), 0, false, 6) / 4;
            ...
            gregorianCalendar.set(2, iM4867 - 1);
        ...
        public final boolean pathMatch(HttpUrl httpUrl, String str) {
            ...
            if (AbstractC1469.m3322(strEncodedPath, str)) {
                return true;
            }
                ...
                if (strTrimSubstring$default.length() != 0 && Util.indexOfControlOrNonAscii(strTrimSubstring$default) == -1) {
                    ...
                    if (Util.indexOfControlOrNonAscii(strTrimSubstring) == -1) {
                        ...
                        while (i < length) {
                            ...
                            if (AbstractC2909.m4916(strTrimSubstring2, "expires")) {
                                try {
                                    expires = parseExpires(strTrimSubstring3, 0, strTrimSubstring3.length());
                                    z2 = true;
                                } catch (NumberFormatException | IllegalArgumentException unused) {
                                }
                            } else if (AbstractC2909.m4916(strTrimSubstring2, "max-age")) {
                                maxAge = parseMaxAge(strTrimSubstring3);
                                z2 = true;
                            } else if (AbstractC2909.m4916(strTrimSubstring2, "domain")) {
                                domain = parseDomain(strTrimSubstring3);
                                z4 = false;
                            } else if (AbstractC2909.m4916(strTrimSubstring2, "path")) {
                                strSubstring = strTrimSubstring3;
                            } else if (AbstractC2909.m4916(strTrimSubstring2, "secure")) {
                                z3 = true;
                            } else if (AbstractC2909.m4916(strTrimSubstring2, "httponly")) {
                                z = true;
                            }
                        ...
                        if (strSubstring == null || !strSubstring.startsWith("/")) {
                            String strEncodedPath = httpUrl.encodedPath();
                            int iM4871 = AbstractC2901.m4871(strEncodedPath, '/', 0, 6);
                            strSubstring = iM4871 != 0 ? strEncodedPath.substring(0, iM4871) : "/";
                        }
    ...
    public /* synthetic */ Cookie(String str, String str2, long j, String str3, String str4, boolean z, boolean z2, boolean z3, boolean z4, AbstractC0985 abstractC0985) {
    ...
    public boolean equals(Object obj) {
        ...
        return AbstractC1469.m3322(cookie.name, this.name) && AbstractC1469.m3322(cookie.value, this.value) && cookie.expiresAt == this.expiresAt && AbstractC1469.m3322(cookie.domain, this.domain) && AbstractC1469.m3322(cookie.path, this.path) && cookie.secure == this.secure && cookie.httpOnly == this.httpOnly && cookie.persistent == this.persistent && cookie.hostOnly == this.hostOnly;
    }
    ...
    public int hashCode() {
        return Boolean.hashCode(this.hostOnly) + ((Boolean.hashCode(this.persistent) + ((Boolean.hashCode(this.httpOnly) + ((Boolean.hashCode(this.secure) + AbstractC2647.m4621(AbstractC2647.m4621((Long.hashCode(this.expiresAt) + AbstractC2647.m4621(AbstractC2647.m4621(527, 31, this.name), 31, this.value)) * 31, 31, this.domain), 31, this.path)) * 31)) * 31)) * 31);
    }
    ...
    public final boolean matches(HttpUrl httpUrl) {
        if ((this.hostOnly ? AbstractC1469.m3322(httpUrl.host(), this.domain) : Companion.domainMatch(httpUrl.host(), this.domain)) && Companion.pathMatch(httpUrl, this.path)) {
