...
public final class HttpUrl {
    ...
    public static final class Builder {
        ...
        public static final class Companion {
            ...
            public final int schemeDelimiterOffset(String str, int i, int i2) {
                ...
                char cCharAt = str.charAt(i);
                if ((AbstractC1469.m3327(cCharAt, 97) >= 0 && AbstractC1469.m3327(cCharAt, 122) <= 0) || (AbstractC1469.m3327(cCharAt, 65) >= 0 && AbstractC1469.m3327(cCharAt, 90) <= 0)) {
                    while (true) {
                        i++;
                        if (i >= i2) {
                            break;
        ...
        private final boolean isDot(String str) {
            return AbstractC1469.m3322(str, ".") || AbstractC2909.m4916(str, "%2e");
        }

        private final boolean isDotDot(String str) {
            return AbstractC1469.m3322(str, "..") || AbstractC2909.m4916(str, "%2e.") || AbstractC2909.m4916(str, ".%2e") || AbstractC2909.m4916(str, "%2e%2e");
        }
        ...
        private final void removeAllCanonicalQueryParameters(String str) {
            ...
            while (true) {
                if (AbstractC1469.m3322(str, this.encodedQueryNamesAndValues.get(size))) {
        ...
        public final HttpUrl build() {
            ...
            if (list2 != null) {
                ArrayList arrayList3 = new ArrayList(AbstractC0741.m2313(list2, 10));
        ...
        public final Builder port(int i) {
            if (1 > i || i >= 65536) {
                throw new IllegalArgumentException(AbstractC1095.m2794(i, "unexpected port: ").toString());
            }
            this.port = i;
            return this;
        }
    ...
    public static final class Companion {
        ...
        private final void writeCanonicalized(C0481 c0481, String str, int i, int i2, String str2, boolean z, boolean z2, boolean z3, boolean z4, Charset charset) throws EOFException {
            C0481 c0482 = null;
            while (i < i2) {
                ...
                if (!z || (iCodePointAt != 9 && iCodePointAt != 10 && iCodePointAt != 12 && iCodePointAt != 13)) {
                    if (iCodePointAt == 43 && z3) {
                        String str3 = z ? "+" : "%2B";
                        c0481.getClass();
                        c0481.m1897(0, str3.length(), str3);
                    } else if (iCodePointAt < 32 || iCodePointAt == 127 || ((iCodePointAt >= 128 && !z4) || AbstractC2901.m4862(str2, (char) iCodePointAt) || (iCodePointAt == 37 && (!z || (z2 && !isPercentEncoded(str, i, i2)))))) {
                        if (c0482 == null) {
                            c0482 = new C0481();
                        }
                        if (charset == null || charset.equals(StandardCharsets.UTF_8)) {
                            c0482.m1899(iCodePointAt);
                        } else {
                            c0482.m1896(str, i, Character.charCount(iCodePointAt) + i, charset);
                        }
                        while (!c0482.mo1860()) {
                            byte b = c0482.readByte();
                            c0481.m1890(37);
                            c0481.m1890(HttpUrl.HEX_DIGITS[((b & 255) >> 4) & 15]);
                            c0481.m1890(HttpUrl.HEX_DIGITS[b & ek.m]);
                        }
                    } else {
                        c0481.m1899(iCodePointAt);
                    }
                }
        ...
        private final void writePercentDecoded(C0481 c0481, String str, int i, int i2, boolean z) {
            int i3;
            while (i < i2) {
                int iCodePointAt = str.codePointAt(i);
                if (iCodePointAt == 37 && (i3 = i + 2) < i2) {
                    ...
                    if (hexDigit == -1 || hexDigit2 == -1) {
                        ...
                        c0481.m1890((hexDigit << 4) + hexDigit2);
        ...
        public final HttpUrl m980deprecated_get(String str) {
            return get(str);
        }

        /* JADX INFO: renamed from: -deprecated_parse, reason: not valid java name */
        public final HttpUrl m983deprecated_parse(String str) {
            return parse(str);
        }
        ...
        public final String canonicalize$okhttp(String str, int i, int i2, String str2, boolean z, boolean z2, boolean z3, boolean z4, Charset charset) throws EOFException {
            ...
            while (iCharCount < i2) {
                ...
                if (iCodePointAt < 32 || iCodePointAt == 127 || ((iCodePointAt >= 128 && !z4) || AbstractC2901.m4862(str2, (char) iCodePointAt) || ((iCodePointAt == 37 && (!z || (z2 && !isPercentEncoded(str, iCharCount, i2)))) || (iCodePointAt == 43 && z3)))) {
                    C0481 c0481 = new C0481();
                    c0481.m1897(i, iCharCount, str);
                    writeCanonicalized(c0481, str, iCharCount, i2, str2, z, z2, z3, z4, charset);
                    return c0481.m1880();
                }
        ...
        public final String percentDecode$okhttp(String str, int i, int i2, boolean z) {
            for (int i3 = i; i3 < i2; i3++) {
                ...
                if (cCharAt == '%' || (cCharAt == '+' && z)) {
                    C0481 c0481 = new C0481();
                    c0481.m1897(i, i3, str);
                    writePercentDecoded(c0481, str, i3, i2, z);
                    return c0481.m1880();
                }
            }
            return str.substring(i, i2);
        ...
        public final List<String> toQueryNamesAndValues$okhttp(String str) {
            ...
            while (i <= str.length()) {
                ...
                if (iM4867 == -1 || iM4867 > iM4866) {
                    arrayList.add(str.substring(i, iM4866));
                    arrayList.add(null);
                } else {
                    arrayList.add(str.substring(i, iM4867));
                    arrayList.add(str.substring(iM4867 + 1, iM4866));
                }
                i = iM4866 + 1;
            }
            return arrayList;
        ...
        public final void toQueryString$okhttp(List<String> list, StringBuilder sb) {
            C1677 c1677M5347 = AbstractC3744.m5347(AbstractC3744.m5348(0, list.size()), 2);
            int i = c1677M5347.f5650;
            int i2 = c1677M5347.f5651;
            int i3 = c1677M5347.f5652;
        ...
        /* JADX INFO: renamed from: -deprecated_get, reason: not valid java name */
        public final HttpUrl m982deprecated_get(URL url) {
            return get(url);
        }
        ...
        /* JADX INFO: renamed from: -deprecated_get, reason: not valid java name */
        public final HttpUrl m981deprecated_get(URI uri) {
            return get(uri);
        }
    ...
    public HttpUrl(String str, String str2, String str3, String str4, int i, List<String> list, List<String> list2, String str5, String str6) {
        ...
        this.fragment = str5;
        this.url = str6;
        this.isHttps = AbstractC1469.m3322(str, "https");
    }
    ...
    public final String encodedFragment() {
        ...
        return this.url.substring(AbstractC2901.m4866('#', 0, 6, this.url) + 1);
    }
    ...
    public final String encodedPassword() {
        ...
        return this.url.substring(AbstractC2901.m4866(':', this.scheme.length() + 3, 4, this.url) + 1, AbstractC2901.m4866('@', 0, 6, this.url));
    }

    public final String encodedPath() {
        int iM4866 = AbstractC2901.m4866('/', this.scheme.length() + 3, 4, this.url);
        String str = this.url;
        return this.url.substring(iM4866, Util.delimiterOffset(str, "?#", iM4866, str.length()));
    }

    public final List<String> encodedPathSegments() {
        int iM4866 = AbstractC2901.m4866('/', this.scheme.length() + 3, 4, this.url);
        String str = this.url;
        int iDelimiterOffset = Util.delimiterOffset(str, "?#", iM4866, str.length());
        ArrayList arrayList = new ArrayList();
        while (iM4866 < iDelimiterOffset) {
            int i = iM4866 + 1;
    ...
    public final String encodedQuery() {
        ...
        int iM4866 = AbstractC2901.m4866('?', 0, 6, this.url) + 1;
        String str = this.url;
        return this.url.substring(iM4866, Util.delimiterOffset(str, '#', iM4866, str.length()));
    }
    ...
    public boolean equals(Object obj) {
        return (obj instanceof HttpUrl) && AbstractC1469.m3322(((HttpUrl) obj).url, this.url);
    }
    ...
    public final Set<String> queryParameterNames() {
        ...
        C1677 c1677M5347 = AbstractC3744.m5347(AbstractC3744.m5348(0, this.queryNamesAndValues.size()), 2);
        int i = c1677M5347.f5650;
        int i2 = c1677M5347.f5651;
        int i3 = c1677M5347.f5652;
        if ((i3 > 0 && i <= i2) || (i3 < 0 && i2 <= i)) {
