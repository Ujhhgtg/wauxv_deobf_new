...
public final class Dispatcher {
    ...
    private final RealCall.AsyncCall findExistingCallWithHost(String str) {
        for (RealCall.AsyncCall asyncCall : this.runningAsyncCalls) {
            if (AbstractC1469.m3322(asyncCall.getHost(), str)) {
                return asyncCall;
            }
        }
        for (RealCall.AsyncCall asyncCall2 : this.readyAsyncCalls) {
            if (AbstractC1469.m3322(asyncCall2.getHost(), str)) {
                return asyncCall2;
            }
        }
        return null;
    ...
    public final ExecutorService m949deprecated_executorService() {
    ...
    public final synchronized List<Call> queuedCalls() {
        ...
        try {
            ...
            arrayList = new ArrayList(AbstractC0741.m2313(arrayDeque, 10));
    ...
    public final synchronized List<Call> runningCalls() {
        ...
        try {
            ...
            arrayList = new ArrayList(AbstractC0741.m2313(arrayDeque2, 10));
        ...
        return Collections.unmodifiableList(AbstractC0739.m2297(arrayDeque, arrayList));
    }
    ...
    public final void setMaxRequests(int i) {
        if (i < 1) {
            throw new IllegalArgumentException(AbstractC1095.m2794(i, "max < 1: ").toString());
        }
        synchronized (this) {
            this.maxRequests = i;
        }
