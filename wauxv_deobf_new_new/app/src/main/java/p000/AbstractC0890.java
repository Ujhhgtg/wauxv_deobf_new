...
/* JADX INFO: renamed from: ᛱᛲᛳᛴᛵᛶᛷᤝᛸᲈᲇᲀᤞᲁ, reason: contains not printable characters */
/* JADX INFO: compiled from: obf */
/* JADX INFO: loaded from: classes.dex */
public abstract class AbstractC0890 extends AbstractC0910 {

    /* JADX INFO: renamed from: ᛱᛲᛳᛴᛵᛶᛷᛸᤝᤞᲀᲈᲁᲇ, reason: contains not printable characters */
    public final C2492 f3337;

    /* JADX INFO: renamed from: ᛱᛲᛳᛴᛵᛶᛷᛸᤝᤞᲀᲈᲇᲁ, reason: contains not printable characters */
    public C2492 f3338;

    public AbstractC0890(C0917 c0917, C0913 c0913) {
        super(c0917, c0913);
        String str = c0913.f3382.f3385;
        if (m2527()) {
            this.f3337 = C2492.m4440(str);
        } else {
            this.f3337 = C2492.m4441(str);
        }
        this.f3338 = null;
    }
    ...
    public final int mo2369(AbstractC0775 abstractC0775) {
        ...
        return iMo2369 != 0 ? iMo2369 : this.f3337.compareTo(((AbstractC0890) abstractC0775).f3337);
    }

    /* JADX WARN: Failed to restore switch over string. Please report as a decompilation issue */
    /* JADX INFO: renamed from: ᛱᛲᛳᛴᛵᛶᛷᛸᤝᤞᲁᲇᲈᲀ, reason: contains not printable characters */
    public final boolean m2527() {
        C0917 c0917 = C0917.f3406;
        C0917 c0918 = this.f3375;
        boolean zEquals = c0918.equals(c0917);
        C0913 c0913 = this.f3376;
        if (zEquals) {
            String str = c0913.f3381.f3385;
            str.getClass();
            if (str.equals("invoke") || str.equals("invokeExact")) {
                return true;
            }
        } else if (c0918.equals(C0917.f3407)) {
            String str2 = c0913.f3381.f3385;
            str2.getClass();
            byte b = -1;
