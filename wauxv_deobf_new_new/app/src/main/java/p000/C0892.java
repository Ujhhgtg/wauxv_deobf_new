...
/* JADX INFO: renamed from: ᛱᛲᛳᛴᛵᛶᛷᤝᛸᲈᲇᲁᤞᲀ, reason: contains not printable characters */
/* JADX INFO: compiled from: obf */
/* JADX INFO: loaded from: classes.dex */
public final class C0892 extends AbstractC0906 {

    /* JADX INFO: renamed from: ᛱᛲᛳᛴᛵᛶᛷᛸᤝᤞᲀᲇᲈᲁ, reason: contains not printable characters */
    public static final C0892 f3341 = new C0892(0);
    ...
    public final String toString() {
        ...
        int i = this.f3371;
        sb.append(AbstractC2902.m4905(i));
        sb.append(" / ");
        sb.append(i);
        sb.append('}');
        return sb.toString();
