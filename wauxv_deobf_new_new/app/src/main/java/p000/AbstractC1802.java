...
/* JADX INFO: renamed from: ᛱᛲᛳᛴᛵᛶᛷᤞᲀᲁᲈᤝᛸᲇ, reason: contains not printable characters */
/* JADX INFO: compiled from: obf */
/* JADX INFO: loaded from: classes.dex */
public abstract class AbstractC1802 {

    /* JADX INFO: renamed from: ᛱᛲᛳᛴᛵᛶᛷᛸᤝᤞᲀᲁᲇᲈ, reason: contains not printable characters */
    public static final HashMap f5956 = new HashMap();

    /* JADX INFO: renamed from: ᛱᛲᛳᛴᛵᛶᛷᛸᤝᤞᲀᲁᲈᲇ, reason: contains not printable characters */
    public static final HashMap f5957 = new HashMap();

    /* JADX INFO: renamed from: ᛱᛲᛳᛴᛵᛶᛷᛸᤝᤞᲀᲁᲇᲈ, reason: contains not printable characters */
    public static void m3684(Constructor constructor, InterfaceC1799 interfaceC1799) {
        try {
            constructor.newInstance(interfaceC1799);
    ...
    /* JADX INFO: renamed from: ᛱᛲᛳᛴᛵᛶᛷᛸᤝᤞᲀᲁᲈᲇ, reason: contains not printable characters */
    public static int m3685(Class cls) {
        ...
        if (cls.getCanonicalName() != null) {
            ...
            try {
                ...
                String strConcat = AbstractC2909.m4918(canonicalName, ".", "_").concat("_LifecycleAdapter");
                if (name.length() != 0) {
            ...
            if (declaredConstructor != null) {
                ...
                if (bool != null) {
                    ...
                    try {
                        ...
                        while (true) {
                            ...
                            if (((InterfaceC2314) declaredMethods[i3].getAnnotation(InterfaceC2314.class)) != null) {
                                c0709.m2234(cls, declaredMethods);
                                zBooleanValue = true;
                                break;
                            }
                            i3++;
                ...
                if (!zBooleanValue) {
                    ...
                    if (!(superclass != null && InterfaceC1799.class.isAssignableFrom(superclass))) {
                        for (Class<?> cls2 : cls.getInterfaces()) {
                            if (cls2 == null && InterfaceC1799.class.isAssignableFrom(cls2)) {
                                z = true;
                            } else {
                                z = false;
                            }
