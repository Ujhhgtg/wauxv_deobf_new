...
public final class C2380 {
    ...
    public C2380(char c, float[] fArr) {
        this.f7640 = c;
        this.f7641 = fArr;
    }

    /* JADX INFO: renamed from: ᛱᛲᛳᛴᛵᛶᛷᛸᤝᤞᲀᲁᲇᲈ, reason: contains not printable characters */
    public static void m4342(Path path, float f, float f2, float f3, float f4, float f5, float f6, float f7, boolean z, boolean z2) {
        double d;
        double d2;
        ...
        if (d17 < 0.0d) {
            ...
            m4342(path, f, f2, f3, f4, f5 * fSqrt, fSqrt * f6, f7, z, z2);
            return;
        }
    ...
    /* JADX INFO: renamed from: ᛱᛲᛳᛴᛵᛶᛷᛸᤝᤞᲀᲁᲈᲇ, reason: contains not printable characters */
    public static void m4343(C2380[] c2380Arr, Path path) {
        int i;
        float f;
        float f2;
        float f3;
        ...
        float f9;
        float f10;
        C2380[] c2380Arr2 = c2380Arr;
        float[] fArr = new float[6];
        int length = c2380Arr2.length;
        int i2 = 0;
        int i3 = 0;
        char c = 'm';
        while (i3 < length) {
            C2380 c2380 = c2380Arr2[i3];
            char c2 = c2380.f7640;
            float[] fArr2 = c2380.f7641;
            float f11 = fArr[i2];
            float f12 = fArr[1];
            float f13 = fArr[2];
            float f14 = fArr[3];
            ...
            while (i5 < fArr2.length) {
                if (c2 == 'A') {
                    ...
                    int i6 = i5 + 5;
                    int i7 = i5 + 6;
                    m4342(path, f19, f21, fArr2[i6], fArr2[i7], fArr2[i5], fArr2[i5 + 1], fArr2[i5 + 2], fArr2[i5 + 3] != 0.0f ? 1 : i4, fArr2[i5 + 4] != 0.0f ? 1 : i4);
                    f13 = fArr2[i6];
                    f = fArr2[i7];
                    f14 = f;
                    f2 = f13;
                    ...
                    float f40 = f20;
                    i3 = i3;
                    m4342(path, f39, f40, f37, f38, fArr2[i5], fArr2[i5 + 1], fArr2[i5 + 2], fArr2[i5 + 3] != 0.0f ? 1 : i4, fArr2[i5 + 4] != 0.0f ? 1 : i4);
                    f2 = f39 + fArr2[i33];
                    f = f40 + fArr2[i34];
                    f13 = f2;
                    f14 = f;
    ...
    public C2380(C2380 c2380) {
        this.f7640 = c2380.f7640;
        float[] fArr = c2380.f7641;
        this.f7641 = AbstractC1471.m3379(fArr, fArr.length);
    }
}
