...
/* JADX INFO: renamed from: ᛱᛲᛳᛴᛵᛶᛷᤝᲇᲁᛸᲈᤞᲀ, reason: contains not printable characters */
/* JADX INFO: loaded from: classes.dex */
public abstract class AbstractC1330 extends AbstractC1470 {
    /* JADX INFO: renamed from: ᛱᛲᛳᛴᛵᛶᛷᛸᤝᤞᲇᲁᲀᲈ, reason: contains not printable characters */
    public static void m3145(File file, File file2) throws IOException {
        if (!file.exists()) {
            throw new C1319(file, null, "The source file doesn't exist.");
        }
        if (file2.exists() && !file2.delete()) {
            throw new C1319(file, file2, "Tried to overwrite the destination, but failed to delete it.");
        }
        if (file.isDirectory()) {
            if (!file2.mkdirs()) {
                throw new C1329(file, file2, "Failed to create target directory.");
            }
            return;
        }
        ...
        try {
            ...
            try {
                ...
                AbstractC3528.m5090(fileInputStream, th3);
                throw th4;
            }
        }
    }
    ...
    public static String m3146(File file) throws IOException {
    ...
    public static void m3147(File file, String str) throws IOException {
        Charset charset = AbstractC0580.UTF_8;
        FileOutputStream fileOutputStream = new FileOutputStream(file);
        try {
            m3148(fileOutputStream, str, charset);
            fileOutputStream.close();
        } catch (Throwable th) {
            try {
                throw th;
    ...
    public static final void m3148(FileOutputStream fileOutputStream, String str, Charset charset) throws IOException {
        if (str.length() < 16384) {
