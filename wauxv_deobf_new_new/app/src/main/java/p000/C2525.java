...
/* JADX INFO: renamed from: ᛱᛲᛳᛴᛵᛶᛷᲀᤞᲁᲈᲇᛸᤝ, reason: contains not printable characters */
/* JADX INFO: compiled from: obf */
/* JADX INFO: loaded from: classes.dex */
public final class C2525 {

    /* JADX INFO: renamed from: ᛱᛲᛳᛴᛵᛶᛷᛸᤝᤞᲀᲈᲇᲁ, reason: contains not printable characters */
    public static final BigInteger f8051 = new BigInteger("ffffffffffffffff", 16);

    /* JADX INFO: renamed from: ᛱᛲᛳᛴᛵᛶᛷᛸᤝᤞᲀᲁᲇᲈ, reason: contains not printable characters */
    public final BigInteger[] f8052;

    /* JADX INFO: renamed from: ᛱᛲᛳᛴᛵᛶᛷᛸᤝᤞᲀᲁᲈᲇ, reason: contains not printable characters */
    public final BigInteger[] f8053;

    /* JADX INFO: renamed from: ᛱᛲᛳᛴᛵᛶᛷᛸᤝᤞᲀᲇᲁᲈ, reason: contains not printable characters */
    public final BigInteger[] f8054;

    /* JADX INFO: renamed from: ᛱᛲᛳᛴᛵᛶᛷᛸᤝᤞᲀᲇᲈᲁ, reason: contains not printable characters */
    public final BigInteger[] f8055;

    /* JADX INFO: renamed from: ᛱᛲᛳᛴᛵᛶᛷᛸᤝᤞᲀᲈᲁᲇ, reason: contains not printable characters */
    public int f8056;

    public C2525(BigInteger bigInteger) {
        String[] strArr = AbstractC1471.f5234;
        BigInteger[] bigIntegerArr = new BigInteger[8];
        for (int i = 0; i < 8; i++) {
            bigIntegerArr[i] = new BigInteger("9e3779b97f4a7c13", 16);
        }
        this.f8052 = bigIntegerArr;
        BigInteger[] bigIntegerArr2 = new BigInteger[bc.e];
        for (int i2 = 0; i2 < 256; i2++) {
            bigIntegerArr2[i2] = BigInteger.ZERO;
        }
        this.f8053 = bigIntegerArr2;
        BigInteger[] bigIntegerArr3 = new BigInteger[bc.e];
        for (int i3 = 0; i3 < 256; i3++) {
            bigIntegerArr3[i3] = BigInteger.ZERO;
        }
        this.f8054 = bigIntegerArr3;
        BigInteger[] bigIntegerArr4 = new BigInteger[bc.e];
        for (int i4 = 0; i4 < 256; i4++) {
            bigIntegerArr4[i4] = BigInteger.ZERO;
        }
        this.f8055 = bigIntegerArr4;
        this.f8056 = 255;
        BigInteger[] bigIntegerArr5 = this.f8054;
        BigInteger[] bigIntegerArr6 = this.f8052;
        BigInteger[] bigIntegerArr7 = this.f8053;
        bigIntegerArr7[0] = bigInteger;
        for (int i5 = 0; i5 < 4; i5++) {
            m4447(bigIntegerArr6);
        }
        C1677 c1677M5347 = AbstractC3744.m5347(AbstractC3744.m5348(0, bigIntegerArr7.length), 8);
        int i6 = c1677M5347.f5650;
        int i7 = c1677M5347.f5651;
        int i8 = c1677M5347.f5652;
        BigInteger bigInteger2 = f8051;
        ...
        C1677 c1677M5348 = AbstractC3744.m5347(AbstractC3744.m5348(0, bigIntegerArr5.length), 8);
        int i11 = c1677M5348.f5650;
        int i12 = c1677M5348.f5651;
        int i13 = c1677M5348.f5652;
    ...
    /* JADX INFO: renamed from: ᛱᛲᛳᛴᛵᛶᛷᛸᤝᤞᲀᲁᲈᲇ, reason: contains not printable characters */
    public static void m4447(BigInteger[] bigIntegerArr) {
        BigInteger bigIntegerSubtract = bigIntegerArr[0].subtract(bigIntegerArr[4]);
        String[] strArr = AbstractC1471.f5234;
        "subtract(...)";
        BigInteger bigInteger = f8051;
    ...
    public final void m4448() {
        BigInteger[] bigIntegerArr = this.f8055;
        int i = 2;
        ...
        while (i3 < 256) {
            ...
            int i5 = (i3 + 128) % bc.e;
            BigInteger[] bigIntegerArr2 = this.f8054;
            ...
            this.f8053[i7] = bigIntegerArr[i6];
            i3 = i7 + 1;
            i2 = i6;
            i = 2;
            c = 0;
