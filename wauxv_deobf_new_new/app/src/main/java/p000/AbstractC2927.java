...
public abstract class AbstractC2927 extends AbstractC1569 {
    ...
    public AbstractC2927(String str) {
        StringBuilder sbM4787 = AbstractC2844.m4787(str);
        sbM4787.append(".enabled");
        this.f9355 = sbM4787.toString();
        this.f9356 = true;
        this.f9357 = true;
        this.f9358 = new String[]{EnumC3735.f11663.f11667};
    }
    ...
    public final boolean mo3445() {
        ...
        if (c0519 != null) {
            return c0519.m1985().getBoolean(this.f9355, false);
        }
        throw new IllegalArgumentException("DefaultConfig must be init".toString());
    }

    /* JADX INFO: renamed from: ᛱᛲᛳᛴᛵᛶᛷᛸᤝᲀᲁᤞᲈᲇ */
    public String mo1273() {
        return null;
    }

    /* JADX INFO: renamed from: ᛱᛲᛳᛴᛵᛶᛷᛸᤝᲀᲁᲇᤞᲈ */
    public abstract String mo1274();

    /* JADX INFO: renamed from: ᛱᛲᛳᛴᛵᛶᛷᛸᤝᲀᲁᲇᲈᤞ */
    public abstract String mo1275();

    /* JADX INFO: renamed from: ᛱᛲᛳᛴᛵᛶᛷᛸᤝᲀᲁᲈᤞᲇ */
    public InterfaceC1433 mo1276() {
        return null;
    }

    /* JADX INFO: renamed from: ᛱᛲᛳᛴᛵᛶᛷᛸᤝᲀᲁᲈᲇᤞ */
    public InterfaceC1433 mo2142() {
        return null;
    }

    /* JADX INFO: renamed from: ᛱᛲᛳᛴᛵᛶᛷᛸᤝᲀᲇᤞᲁᲈ */
    public boolean mo4271() {
        return this.f9357;
    }
