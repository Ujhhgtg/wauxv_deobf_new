...
public final class C0362 extends AbstractC1260 {

    /* JADX INFO: renamed from: ᛱᛲᛳᛴᛵᛶᛷᛸᤝᤞᲇᲈᲀᲁ, reason: contains not printable characters */
    public final Slider f1763;

    /* JADX INFO: renamed from: ᛱᛲᛳᛴᛵᛶᛷᛸᤝᤞᲇᲈᲁᲀ, reason: contains not printable characters */
    public final Rect f1764;

    public C0362(Slider slider) {
        super(slider);
        this.f1764 = new Rect();
        this.f1763 = slider;
    }
    ...
    public final int mo1649(float f, float f2) {
        int i = 0;
        while (true) {
            Slider slider = this.f1763;
            if (i >= slider.getValues().size()) {
                return -1;
            }
            Rect rect = this.f1764;
            slider.m1673(i, rect);
    ...
    public final void mo1650(ArrayList arrayList) {
        for (int i = 0; i < this.f1763.getValues().size(); i++) {
    ...
    public final boolean mo1651(int i, int i2, Bundle bundle) {
        ...
        if (i2 != 4096 && i2 != 8192) {
            if (i2 != 16908349 || bundle == null || !bundle.containsKey("android.view.accessibility.action.ARGUMENT_PROGRESS_VALUE") || !slider.m1671(i, bundle.getFloat("android.view.accessibility.action.ARGUMENT_PROGRESS_VALUE"))) {
                return false;
            }
            slider.m1674();
        ...
        float fRound = slider.f1817;
        if (fRound == 0.0f) {
            fRound = 1.0f;
        }
        float f = (slider.f1813 - slider.f1812) / fRound;
        float f2 = 20;
        if (f > f2) {
    ...
    public final void mo1652(int i, C0100 c0100) {
        ...
        c0100.m1241(SeekBar.class.getName());
