...
public class SwitchPreference extends TwoStatePreference {
    ...
    public SwitchPreference(Context context, AttributeSet attributeSet) {
        int iM3386 = AbstractC1471.m3386(context, R.attr.switchPreferenceStyle, android.R.attr.switchPreferenceStyle);
        super(context, attributeSet, iM3386);
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, AbstractC2519.f7982, iM3386, 0);
