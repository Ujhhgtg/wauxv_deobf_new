...
public class Preference implements Comparable<Preference> {
    ...
    public InterfaceC2443 f315;

    public Preference(Context context, AttributeSet attributeSet, int i) {
        this.f310 = Integer.MAX_VALUE;
        this.f309 = context;
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, AbstractC2519.f7978, i, 0);
    ...
    public CharSequence mo106() {
        ...
        return interfaceC2443 != null ? interfaceC2443.mo1612(this) : this.f312;
    }
    ...
    public Preference(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, AbstractC1471.m3386(context, R.attr.preferenceStyle, android.R.attr.preferenceStyle));
    }
}
