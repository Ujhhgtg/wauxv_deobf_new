...
public class ActionBarContainer extends FrameLayout {
    ...
    public ActionBarContainer(Context context, AttributeSet attributeSet) {
        ...
        setBackground(new C0130(this));
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, AbstractC2523.f8026);
        boolean z = false;
    ...
    public void setTabContainer(AbstractC2702 abstractC2702) {
    }
}
