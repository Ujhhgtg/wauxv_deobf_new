...
public class ActionBarContextView extends ViewGroup {
    ...
    public ActionBarContextView(Context context, AttributeSet attributeSet) {
        ...
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, AbstractC2523.f8029, R.attr.actionModeStyle, 0);
        setBackground((!typedArrayObtainStyledAttributes.hasValue(0) || (resourceId = typedArrayObtainStyledAttributes.getResourceId(0, 0)) == 0) ? typedArrayObtainStyledAttributes.getDrawable(0) : C1787.m3667(context, resourceId));
    ...
    public final void onConfigurationChanged(Configuration configuration) {
        ...
        TypedArray typedArrayObtainStyledAttributes = getContext().obtainStyledAttributes(null, AbstractC2523.f8026, R.attr.actionBarStyle, 0);
    ...
    public void setTitle(CharSequence charSequence) {
        ...
        m8();
        AbstractC3638.m5184(this, charSequence);
    }
