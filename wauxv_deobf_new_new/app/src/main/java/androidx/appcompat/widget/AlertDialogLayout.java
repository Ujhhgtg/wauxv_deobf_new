...
public class AlertDialogLayout extends AbstractC1808 {
    ...
    public final void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        for (int i11 = 0; i11 < childCount; i11++) {
            ...
            if (childAt != null && childAt.getVisibility() != 8) {
                ...
                int i12 = ((LinearLayout.LayoutParams) c1807).gravity;
                if (i12 < 0) {
                    i12 = i10;
                }
                ...
                if (absoluteGravity != 1) {
                    if (absoluteGravity != 5) {
                        i7 = ((LinearLayout.LayoutParams) c1807).leftMargin + paddingLeft;
                    } else {
                        i5 = paddingRight - measuredWidth;
                        i6 = ((LinearLayout.LayoutParams) c1807).rightMargin;
                    }
                    if (m3690(i11)) {
                        paddingTop += intrinsicHeight;
                    }
                    int i13 = paddingTop + ((LinearLayout.LayoutParams) c1807).topMargin;
                    childAt.layout(i7, i13, measuredWidth + i7, i13 + measuredHeight2);
                    paddingTop = measuredHeight2 + ((LinearLayout.LayoutParams) c1807).bottomMargin + i13;
                } else {
                    i5 = ((paddingRight2 - measuredWidth) / 2) + paddingLeft + ((LinearLayout.LayoutParams) c1807).leftMargin;
                    i6 = ((LinearLayout.LayoutParams) c1807).rightMargin;
                }
                i7 = i5 - i6;
                if (m3690(i11)) {
                ...
                int i14 = paddingTop + ((LinearLayout.LayoutParams) c1807).topMargin;
                childAt.layout(i7, i14, measuredWidth + i7, i14 + measuredHeight2);
                paddingTop = measuredHeight2 + ((LinearLayout.LayoutParams) c1807).bottomMargin + i14;
            }
        }
    }
        ...
        if (mode2 != 1073741824) {
            ...
            while (i8 < childCount) {
                ...
                if (childAt3.getVisibility() != 8) {
                    ...
                    if (((LinearLayout.LayoutParams) c1807).width == -1) {
                        int i9 = ((LinearLayout.LayoutParams) c1807).height;
                        ((LinearLayout.LayoutParams) c1807).height = childAt3.getMeasuredHeight();
                        alertDialogLayout.measureChildWithMargins(childAt3, iMakeMeasureSpec, 0, i7, 0);
                        ((LinearLayout.LayoutParams) c1807).height = i9;
                    }
                }
                i8++;
