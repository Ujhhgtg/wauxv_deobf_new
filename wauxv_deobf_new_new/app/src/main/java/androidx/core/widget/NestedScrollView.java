...
public class NestedScrollView extends FrameLayout implements InterfaceC2172 {

    /* JADX INFO: renamed from: ᛱᛲᛳᛴᛵᛶᛷᛸᤝᲀᲁᤞᲇᲈ, reason: contains not printable characters */
    public static final float f255 = (float) (Math.log(0.78d) / Math.log(0.9d));

    /* JADX INFO: renamed from: ᛱᛲᛳᛴᛵᛶᛷᛸᤝᲀᲁᤞᲈᲇ, reason: contains not printable characters */
    public static final C1938 f256 = new C1938(1);
    ...
    public final C2173 f282;

    /* JADX INFO: renamed from: ᛱᛲᛳᛴᛵᛶᛷᛸᤝᲀᤞᲇᲈᲁ, reason: contains not printable characters */
    public final C2170 f283;

    /* JADX INFO: renamed from: ᛱᛲᛳᛴᛵᛶᛷᛸᤝᲀᤞᲈᲁᲇ, reason: contains not printable characters */
    public float f284;

    /* JADX INFO: renamed from: ᛱᛲᛳᛴᛵᛶᛷᛸᤝᲀᤞᲈᲇᲁ, reason: contains not printable characters */
    public final C1043 f285;
    ...
    public NestedScrollView(Context context, AttributeSet attributeSet) {
        ...
        this.f277 = new int[2];
        this.f278 = new int[2];
        this.f285 = new C1043(getContext(), new C1681((Object) this));
        int i = Build.VERSION.SDK_INT;
        this.f262 = i >= 31 ? AbstractC1138.m2851(context, attributeSet) : new EdgeEffect(context);
        this.f263 = i >= 31 ? AbstractC1138.m2851(context, attributeSet) : new EdgeEffect(context);
        ...
        this.f282 = new C2173();
        this.f283 = new C2170(this);
        setNestedScrollingEnabled(true);
        AbstractC3638.m5183(this, f256);
    }

    private C2701 getScrollFeedbackProvider() {
        if (this.f264 == null) {
            this.f264 = new C2701(this);
        }
        return this.f264;
    }
    ...
    public final void computeScroll() {
        ...
        if (i2 <= 0 || AbstractC2727.m4701(edgeEffect) == 0.0f) {
            if (i2 < 0 && AbstractC2727.m4701(edgeEffect2) != 0.0f) {
                float f = height;
                iRound = Math.round(AbstractC2727.m4710(edgeEffect2, (i2 * 4.0f) / f, 0.5f) * (f / 4.0f));
                if (iRound != i2) {
                    edgeEffect2.finish();
                }
            }
            ...
            iArr = this.f278;
            iArr[1] = 0;
            this.f283.m4130(iArr, 0, i3, 1, null);
            i = i3 - iArr[1];
            scrollRange = getScrollRange();
            if (Build.VERSION.SDK_INT >= 35) {
                AbstractC2167.m4127(this, Math.abs(this.f261.getCurrVelocity()));
            }
            if (i != 0) {
                ...
                int i4 = i - scrollY2;
                iArr[1] = 0;
                this.f283.m4131(0, scrollY2, 0, i4, this.f277, 1, iArr);
                i = i4 - iArr[1];
            }
            if (i != 0) {
        ...
        iRound = Math.round(AbstractC2727.m4710(edgeEffect, ((-i2) * 4.0f) / height, 0.5f) * ((-height) / 4.0f));
        if (iRound != i2) {
            edgeEffect.finish();
        }
        i2 -= iRound;
        ...
        iArr = this.f278;
        iArr[1] = 0;
        this.f283.m4130(iArr, 0, i5, 1, null);
        i = i5 - iArr[1];
        scrollRange = getScrollRange();
        if (Build.VERSION.SDK_INT >= 35) {
            AbstractC2167.m4127(this, Math.abs(this.f261.getCurrVelocity()));
        ...
        if (i != 0) {
            ...
            int i6 = i - scrollY4;
            iArr[1] = 0;
            this.f283.m4131(0, scrollY4, 0, i6, this.f277, 1, iArr);
            i = i6 - iArr[1];
        }
        if (i != 0) {
            overScrollMode = getOverScrollMode();
    ...
    public final boolean dispatchNestedFling(float f, float f2, boolean z) {
        return this.f283.m4128(f, f2, z);
    }

    @Override // android.view.View
    public final boolean dispatchNestedPreFling(float f, float f2) {
        return this.f283.m4129(f, f2);
    }

    @Override // android.view.View
    public final boolean dispatchNestedPreScroll(int i, int i2, int[] iArr, int[] iArr2) {
        return this.f283.m4130(iArr, i, i2, 0, iArr2);
    }

    @Override // android.view.View
    public final boolean dispatchNestedScroll(int i, int i2, int i3, int i4, int[] iArr) {
        return this.f283.m4131(i, i2, i3, i4, iArr, 0, null);
    }
    ...
    public final boolean hasNestedScrollingParent() {
        return this.f283.m4133(0);
    }

    @Override // android.view.View
    public final boolean isNestedScrollingEnabled() {
        return this.f283.f7198;
    }
    ...
    public final boolean onGenericMotionEvent(MotionEvent motionEvent) {
        ...
        if (motionEvent.getAction() == 8 && !this.f269) {
            if (AbstractC3528.m5101(motionEvent, 2)) {
                axisValue = motionEvent.getAxisValue(9);
                i = 9;
                width = (int) motionEvent.getX();
            } else if (AbstractC3528.m5101(motionEvent, 4194304)) {
            ...
            if (axisValue != 0.0f) {
                m87(-((int) (getVerticalScrollFactorCompat() * axisValue)), i, motionEvent, width, 1, AbstractC3528.m5101(motionEvent, r.a.s));
                if (i == 0) {
                    return true;
                }
                this.f285.m2730(motionEvent, i);
                return true;
            }
        }
        return false;
    ...
    public final void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (!this.f267) {
            if (this.f281 != null) {
                scrollTo(getScrollX(), this.f281.f7194);
                this.f281 = null;
            }
            if (getChildCount() > 0) {
                View childAt = getChildAt(0);
    ...
    public final void onNestedPreScroll(View view, int i, int i2, int[] iArr) {
        this.f283.m4130(iArr, i, i2, 0, null);
    }
    ...
    public final void onRestoreInstanceState(Parcelable parcelable) {
        if (!(parcelable instanceof C2169)) {
            super.onRestoreInstanceState(parcelable);
            return;
        }
        C2169 c2169 = (C2169) parcelable;
        super.onRestoreInstanceState(c2169.getSuperState());
        this.f281 = c2169;
        requestLayout();
    }
    ...
    public final Parcelable onSaveInstanceState() {
        C2169 c2169 = new C2169(super.onSaveInstanceState());
        c2169.f7194 = getScrollY();
        return c2169;
    }
        ...
        if (actionMasked != 0) {
            ...
            if (actionMasked == 1) {
                ...
                if (Math.abs(yVelocity) >= this.f274) {
                    if (AbstractC2727.m4701(edgeEffect) != 0.0f) {
                        if (m88(edgeEffect, yVelocity)) {
                            edgeEffect.onAbsorb(yVelocity);
                        } else {
                            m79(-yVelocity);
                        }
                    } else if (AbstractC2727.m4701(edgeEffect2) != 0.0f) {
                        int i2 = -yVelocity;
                ...
                if (iFindPointerIndex == -1) {
                    ...
                    if (AbstractC2727.m4701(edgeEffect) != 0.0f) {
                        fM4710 = -AbstractC2727.m4710(edgeEffect, -height, x);
                        if (AbstractC2727.m4701(edgeEffect) == 0.0f) {
                            edgeEffect.onRelease();
                        }
                    } else if (AbstractC2727.m4701(edgeEffect2) != 0.0f) {
                        fM4710 = AbstractC2727.m4710(edgeEffect2, height, 1.0f - x);
                        if (AbstractC2727.m4701(edgeEffect2) == 0.0f) {
                            edgeEffect2.onRelease();
                        }
                    } else {
    ...
    public void setNestedScrollingEnabled(boolean z) {
        C2170 c2170 = this.f283;
        if (c2170.f7198) {
            ViewGroup viewGroup = c2170.f7197;
    ...
    public final void mo16(View view, int i, int i2, int[] iArr, int i3) {
        this.f283.m4130(iArr, i, i2, i3, null);
    }
    ...
    public final void m82(int i, int i2, int[] iArr) {
        ...
        this.f283.m4131(0, scrollY2, 0, i - scrollY2, null, i2, iArr);
    }
    ...
    public final int m87(int i, int i2, MotionEvent motionEvent, int i3, int i4, boolean z) {
        ...
        boolean zM4130 = this.f283.m4130(this.f278, 0, i, i4, this.f277);
        int[] iArr = this.f277;
        int[] iArr2 = this.f278;
        if (zM4130) {
            i5 = i - iArr2[1];
        ...
        boolean z5 = m84(i5, 0, scrollY, scrollRange) && !c2170.m4133(i4);
        int scrollY2 = getScrollY() - scrollY;
        if (motionEvent != null && scrollY2 != 0) {
            getScrollFeedbackProvider().f8697.onScrollProgress(motionEvent.getDeviceId(), motionEvent.getSource(), i2, scrollY2);
        }
        iArr2[1] = 0;
        this.f283.m4131(0, scrollY2, 0, i5 - scrollY2, this.f277, i4, iArr2);
        int i7 = i6 + iArr[1];
        int i8 = i5 - iArr2[1];
        int i9 = scrollY + i8;
        ...
        if (i9 >= 0) {
            if (i9 > scrollRange && z4) {
                AbstractC2727.m4710(edgeEffect, i8 / getHeight(), 1.0f - (i3 / getWidth()));
                if (motionEvent != null) {
                    z2 = false;
                    getScrollFeedbackProvider().f8697.onScrollLimit(motionEvent.getDeviceId(), motionEvent.getSource(), i2, false);
                } else {
                    z2 = false;
                }
                if (!edgeEffect2.isFinished()) {
        ...
        if (z4) {
            AbstractC2727.m4710(edgeEffect2, (-i8) / getHeight(), i3 / getWidth());
            if (motionEvent != null) {
                getScrollFeedbackProvider().f8697.onScrollLimit(motionEvent.getDeviceId(), motionEvent.getSource(), i2, true);
            }
            if (!edgeEffect.isFinished()) {
                edgeEffect.onRelease();
            }
    ...
    public final boolean m88(EdgeEffect edgeEffect, int i) {
        ...
        float fM4701 = AbstractC2727.m4701(edgeEffect) * getHeight();
    ...
    public final boolean m90(MotionEvent motionEvent) {
        ...
        EdgeEffect edgeEffect = this.f262;
        if (AbstractC2727.m4701(edgeEffect) != 0.0f) {
            AbstractC2727.m4710(edgeEffect, 0.0f, motionEvent.getX() / getWidth());
            z = true;
        } else {
            z = false;
        }
        ...
        AbstractC2727.m4710(edgeEffect2, 0.0f, 1.0f - (motionEvent.getX() / getWidth()));
        return true;
    }
    ...
    public void setOnScrollChangeListener(InterfaceC2168 interfaceC2168) {
    }
}
