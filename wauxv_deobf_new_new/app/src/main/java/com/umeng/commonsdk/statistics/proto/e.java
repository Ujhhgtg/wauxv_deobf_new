...
public class e implements de<e, EnumC0050e>, Serializable, Cloneable {
    public static final Map<EnumC0050e, dq> d;
    ...
    static {
        ...
        EnumMap enumMap = new EnumMap(EnumC0050e.class);
        enumMap.put(EnumC0050e.VALUE, new dq("value", (byte) 2, new dr((byte) 11)));
        enumMap.put(EnumC0050e.TS, new dq("ts", (byte) 2, new dr((byte) 10)));
        enumMap.put(EnumC0050e.GUID, new dq("guid", (byte) 2, new dr((byte) 11)));
        Map<EnumC0050e, dq> mapUnmodifiableMap = Collections.unmodifiableMap(enumMap);
    ...
    public e() {
        this.l = (byte) 0;
        this.m = new EnumC0050e[]{EnumC0050e.VALUE, EnumC0050e.TS, EnumC0050e.GUID};
    }
    ...
    /* JADX INFO: compiled from: obf */
    public enum EnumC0050e implements dl {
        VALUE(1, "value"),
        TS(2, "ts"),
        GUID(3, "guid");

        private static final Map<String, EnumC0050e> d = new HashMap();
        private final short e;
        private final String f;

        static {
            for (EnumC0050e enumC0050e : EnumSet.allOf(EnumC0050e.class)) {
                d.put(enumC0050e.b(), enumC0050e);
            }
        }

        EnumC0050e(short s, String str) {
            this.e = s;
            this.f = str;
        }
        ...
        public static EnumC0050e b(int i) {
            EnumC0050e enumC0050eA = a(i);
            if (enumC0050eA != null) {
                return enumC0050eA;
            }
        ...
        public static EnumC0050e a(String str) {
            return d.get(str);
        }
    ...
    @Override // com.umeng.analytics.pro.de
    /* JADX INFO: renamed from: a, reason: merged with bridge method [inline-methods] */
    public EnumC0050e fieldForId(int i2) {
        return EnumC0050e.a(i2);
    }
