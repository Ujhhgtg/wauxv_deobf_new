...
public class a implements UMImprintChangeCallback {
    ...
    private static FileObserverC0043a i = null;
    ...
    /* JADX INFO: compiled from: obf */
    public static class FileObserverC0043a extends FileObserver {
        public FileObserverC0043a(String str) {
            super(str);
        }
    ...
    public a(Context context, Handler handler) {
        ...
        try {
            if (a == null) {
                ...
                handlerThread.start();
                if (i == null) {
                    FileObserverC0043a fileObserverC0043a = new FileObserverC0043a(UMFrUtils.getEnvelopeDirPath(context));
                    i = fileObserverC0043a;
                    fileObserverC0043a.startWatching();
