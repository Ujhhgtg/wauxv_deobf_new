...
public class UMConfigure {
    ...
    public static void setLogEnabled(boolean z) {
        try {
            ...
            if (debugLog) {
                AbstractC2647.m4627("set log enabled e is ", e, TAG);
            }
        } catch (Throwable th) {
            if (debugLog) {
                AbstractC2647.m4628("set log enabled e is ", TAG, th);
            }
        }
    }
    ...
    public static void init(Context context, String str, String str2, int i, String str3) {
        ...
        try {
            try {
                ...
                if (debugLog) {
                    AbstractC2647.m4627("init e is ", e, TAG);
                }
            }
        } catch (Throwable th2) {
            if (debugLog) {
                AbstractC2647.m4628("init e is ", TAG, th2);
            }
        }
    }
