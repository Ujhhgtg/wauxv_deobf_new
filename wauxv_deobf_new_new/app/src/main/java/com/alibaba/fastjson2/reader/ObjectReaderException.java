...
final class ObjectReaderException<T> extends ObjectReaderAdapter<T> {
    ...
    public ObjectReaderException(Class<T> cls) {
        this(cls, Arrays.asList(BeanUtils.getConstructor(cls)), ObjectReaders.fieldReader("stackTrace", StackTraceElement[].class, new C2283(0)));
    }
            ...
            if (jSONReader.isSupportAutoType(j) || context.getContextAutoTypeBeforeHandler() != null) {
                ...
                if (objectReaderAutoType == null) {
                    ...
                    if (objectReaderAutoType2 == null) {
                        StringBuilder sbM4625 = AbstractC2647.m4625("autoType not support : ", string, ", offset ");
                        sbM4625.append(jSONReader.getOffset());
