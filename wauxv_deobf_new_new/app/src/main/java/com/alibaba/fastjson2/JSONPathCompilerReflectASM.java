...
final class JSONPathCompilerReflectASM extends JSONPathCompilerReflect {
    ...
    static {
        ...
        METHOD_SINGLE_NAME_PATH_TYPED_INIT = AbstractC2844.m4786(sb, ASMUtils.DESC_FIELD_WRITER, ")V");
    }
    ...
    private void gwGetValue(MethodWriter methodWriter, String str, FieldWriter fieldWriter) {
        ...
        if (method == null) {
            ...
            methodWriter.invokevirtual(str, method.getName(), AbstractC2844.m4790("()", strDesc));
        }
    }
