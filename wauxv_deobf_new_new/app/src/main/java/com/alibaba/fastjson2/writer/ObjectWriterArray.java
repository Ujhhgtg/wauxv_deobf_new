...
final class ObjectWriterArray extends ObjectWriterPrimitiveImpl {
    ...
    public ObjectWriterArray(Type type) {
        ...
        if (type == Object.class) {
            ...
            strM4790 = AbstractC2844.m4790("{\"@type\":\"", str);
        }
        String strM4782 = AbstractC2844.m4782(strM4790, "\",\"@value\":[");
        this.prefixChars = strM4782.toCharArray();
        this.prefixBytes = strM4782.getBytes(StandardCharsets.UTF_8);
    }
