...
final class ObjectWriterImplDate extends DateTimeCodec implements ObjectWriter {
    ...
    public void write(JSONWriter jSONWriter, Object obj, Object obj2, Type type, long j) {
        ...
        if (dateFormat == null) {
            ...
            long jM4771 = AbstractC2844.m4771(j6, 400L, ((j6 / 4) + (j6 * 365)) - (j6 / 100), j5);
            if (jM4771 < 0) {
                j6--;
                jM4771 = AbstractC2844.m4771(j6, 400L, ((j6 / 4) + (365 * j6)) - (j6 / 100), j5);
            }
            int i = (int) jM4771;
            ...
            if (j7 < -999999999 || j7 > 999999999) {
                throw new DateTimeException(AbstractC2844.m4780(j7, "Invalid year "));
            }
            zoneId = zoneId2;
            int i5 = (int) j7;
            long j8 = iFloorMod;
            if (j8 < 0 || j8 > 86399) {
                throw new DateTimeException(AbstractC2844.m4780(j8, "Invalid secondOfDay "));
            }
            context = context2;
