...
public abstract class JSONWriter implements Closeable {
    ...
    public static IllegalArgumentException illegalYear(int i) {
        return new IllegalArgumentException(AbstractC1095.m2794(i, "Only 4 digits numbers are supported. Provided: "));
    }
    ...
    public final int newCapacity(int i, int i2) {
        ...
        StringBuilder sbM2802 = AbstractC1095.m2802(i, "Maximum array size exceeded. Try enabling LargeObject feature instead. Requested size: ", ", max size: ");
        sbM2802.append(this.maxArraySize);
        throw new JSONLargeObjectException(sbM2802.toString());
    }
