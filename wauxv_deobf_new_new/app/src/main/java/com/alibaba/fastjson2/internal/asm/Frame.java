...
class Frame {
    ...
    private static int getAbstractTypeFromDescriptor(SymbolTable symbolTable, String str, int i) {
        ...
        byte b = 0;
        String strM4778 = "com/alibaba/fastjson2/reader/FieldReader";
        if (cCharAt != 'L') {
            if (cCharAt != 'S') {
                if (cCharAt == 'V') {
                    return 0;
                            ...
                            if (cCharAt2 == 'F') {
                                ...
                                if (i != 0) {
                                    ...
                                    if (str.equals("[Lcom/alibaba/fastjson2/reader/FieldReader;")) {
                                        strM4778 = "Lcom/alibaba/fastjson2/reader/FieldReader";
                                    } else {
                                        strM4778 = null;
                                    }
                                }
                                if (strM4778 == null) {
                                    strM4778 = AbstractC2844.m4778(1, i2 + 1, str);
                                }
                                iAddType = symbolTable.addType(strM4778) | REFERENCE_KIND;
                            } else if (cCharAt2 == 'S') {
                                iAddType = SHORT;
                            } else if (cCharAt2 == 'Z') {
                                iAddType = BOOLEAN;
        ...
        String strM4779 = "java/lang/String";
        if (i == 0) {
            switch (str.hashCode()) {
                case -1603319396:
            ...
            switch (b) {
                case 0:
                    strM4778 = "com/alibaba/fastjson2/writer/FieldWriter";
                    break;
                case 1:
                    break;
                case 2:
                    strM4778 = "com/alibaba/fastjson2/JSONReader";
                    break;
                case 3:
                    strM4778 = "sun/misc/Unsafe";
                    break;
                case 4:
                    strM4778 = "java/util/List";
                    break;
                case 5:
                    strM4778 = "java/util/function/Supplier";
                    break;
                case 6:
                    strM4778 = "com/alibaba/fastjson2/JSONWriter";
                    break;
                case 7:
                    strM4778 = "com/alibaba/fastjson2/reader/ObjectReader";
                    break;
                case 8:
                    strM4778 = "java/lang/String";
                    break;
                case 9:
                    strM4778 = "java/lang/Class";
                    break;
                case 10:
                    strM4778 = ASMUtils.TYPE_OBJECT;
                    break;
                case 11:
                    strM4778 = "java/lang/reflect/Type";
                    break;
                default:
                    strM4778 = null;
                    break;
            ...
            if (i == 3) {
                ...
                if (i != 54) {
                    ...
                    switch (b) {
                        ...
                        case 1:
                            if (i != 60) {
                                ...
                                strM4779 = "com/alibaba/fastjson2/writer/ObjectWriter";
                            }
                            break;
                        case 2:
                            if (i != 62) {
                    ...
                    strM4779 = "com/alibaba/fastjson2/reader/ObjectReader";
            ...
            strM4779 = "java/lang/Class";
        } else if (!str.equals("()Ljava/lang/String;")) {
            strM4779 = null;
        }
        if (strM4779 == null) {
            strM4779 = AbstractC2844.m4778(1, i + 1, str);
        }
        return symbolTable.addType(strM4779) | REFERENCE_KIND;
    }
