...
public abstract class CSVReader<T> extends StreamReader<T> implements Closeable {
    ...
    public Object error(int i, Exception exc) {
        ...
        String strM4785 = AbstractC2844.m4785(new StringBuilder("read csv error, line "), this.rowCount, ", column ");
        ...
        if (str == null || str.isEmpty()) {
            ...
            strM4782 = AbstractC2844.m4782(strM4785, str);
        }
        throw new JSONException(strM4782, exc);
    }
    ...
    public List<String> readHeader() {
        ...
        IntStream.range(0, strArr.length).forEach(new IntConsumer() { // from class: ᛱᛲᛳᛴᛵᛶᛷᛸᲁᲈᤞᲇᤝᲀ
            @Override // java.util.function.IntConsumer
            public final void accept(int i2) {
                this.f2210.lambda$readHeader$0(strArr, i2);
            }
        });
        if (this.rowCount == 1) {
