...
public interface JSONB {
    ...
    static String typeName(byte b) {
        if (b == 72) {
            return AbstractC1095.m2796(b, new StringBuilder("INT32 "));
        }
        if (b == 127) {
            return AbstractC1095.m2796(b, new StringBuilder("SYMBOL "));
        }
        switch (b) {
            case -111:
                return AbstractC1095.m2796(b, new StringBuilder("BINARY "));
            case -110:
                return AbstractC1095.m2796(b, new StringBuilder("TYPED_ANY "));
            case -109:
                return AbstractC1095.m2796(b, new StringBuilder("REFERENCE "));
            default:
                switch (b) {
                    case -91:
                        return AbstractC1095.m2796(b, new StringBuilder("OBJECT_END "));
                    case -90:
                        return AbstractC1095.m2796(b, new StringBuilder("OBJECT "));
                    case -89:
                        return AbstractC1095.m2796(b, new StringBuilder("LOCAL_TIME "));
                    case -88:
                        return AbstractC1095.m2796(b, new StringBuilder("LOCAL_DATETIME "));
                    case -87:
                        return AbstractC1095.m2796(b, new StringBuilder("LOCAL_DATE "));
                    case -86:
                        return AbstractC1095.m2796(b, new StringBuilder("TIMESTAMP_WITH_TIMEZONE "));
                    case -85:
                        return AbstractC1095.m2796(b, new StringBuilder("TIMESTAMP_MILLIS "));
                    case -84:
                        return AbstractC1095.m2796(b, new StringBuilder("TIMESTAMP_SECONDS "));
                    case -83:
                        return AbstractC1095.m2796(b, new StringBuilder("TIMESTAMP_MINUTES "));
                    case -82:
                        return AbstractC1095.m2796(b, new StringBuilder("TIMESTAMP "));
                    case -81:
                        return AbstractC1095.m2796(b, new StringBuilder("NULL "));
                    case -80:
                        return AbstractC1095.m2796(b, new StringBuilder("FALSE "));
                    case -79:
                        return AbstractC1095.m2796(b, new StringBuilder("TRUE "));
                    case -78:
                    case -77:
                    case -76:
                    case -75:
                        return AbstractC1095.m2796(b, new StringBuilder("DOUBLE "));
                    case -74:
                    case -73:
                        return AbstractC1095.m2796(b, new StringBuilder("FLOAT "));
                    case -72:
                    case -71:
                        return AbstractC1095.m2796(b, new StringBuilder("DECIMAL "));
                    case -70:
                    case -69:
                        return AbstractC1095.m2796(b, new StringBuilder("BIGINT "));
                    case -68:
                        return AbstractC1095.m2796(b, new StringBuilder("INT16 "));
                    case -67:
                        return AbstractC1095.m2796(b, new StringBuilder("INT8 "));
                    case -66:
                    case -65:
                        return AbstractC1095.m2796(b, new StringBuilder("INT64 "));
                    default:
                        switch (b) {
                            case 122:
                                return AbstractC1095.m2796(b, new StringBuilder("STR_UTF8 "));
                            case Opcodes.LSHR /* 123 */:
                                return AbstractC1095.m2796(b, new StringBuilder("STR_UTF16 "));
                            case Opcodes.IUSHR /* 124 */:
                                return AbstractC1095.m2796(b, new StringBuilder("STR_UTF16LE "));
                            case Opcodes.LUSHR /* 125 */:
                                return AbstractC1095.m2796(b, new StringBuilder("STR_UTF16BE "));
                            default:
                                if (b >= -108 && b <= -92) {
                                    return AbstractC1095.m2796(b, new StringBuilder("ARRAY "));
                                }
                                if (b >= 73 && b <= 121) {
                                    return AbstractC1095.m2796(b, new StringBuilder("STR_ASCII "));
                                }
                                if (b >= -16 && b <= 47) {
                                    return AbstractC1095.m2796(b, new StringBuilder("INT32 "));
                                }
                                ...
                                if (b < -56 || b > -41) {
                                    return (b < -64 || b > -57) ? Integer.toString(b) : AbstractC1095.m2796(b, new StringBuilder("INT64 "));
                                }
                                return AbstractC1095.m2796(b, new StringBuilder("INT64 "));
                        }
                }
