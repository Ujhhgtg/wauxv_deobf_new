        ...
        public String getInferSQLType() {
            ...
            if (this.nonAsciiStrings <= 0 && (i = this.nulls) != (i2 = this.values)) {
                ...
                if (i2 == this.integers + i) {
                    ...
                    return i3 < 20 ? "BIGINT" : AbstractC2844.m4785(new StringBuilder("DECIMAL("), this.precision, ", 0)");
                }
                if (i2 == this.numbers + i) {
                    ...
                    return AbstractC2844.m4785(AbstractC1095.m2802(i4, "DECIMAL(", ", "), this.scale, ")");
                }
            }
            return "STRING";
        }
