...
public class GridLayoutManager extends androidx.recyclerview.widget.GridLayoutManager {
    ...
    public final void mo165(int i) {
        RecyclerView recyclerView = this.f966;
    ...
    public final void mo167(RecyclerView recyclerView, C2559 c2559, int i) {
        RecyclerView recyclerView2 = this.f966;
        if (recyclerView2 != null) {
            recyclerView2.getAdapter();
        }
        super.mo167(recyclerView, c2559, i);
    }

    @Override // androidx.recyclerview.widget.LinearLayoutManager
    /* JADX INFO: renamed from: ᛱᛲᛳᛴᛵᛶᛷᛸᤝᲇᲈᲁᲀᤞ */
    ...
    @Override // androidx.recyclerview.widget.LinearLayoutManager
    /* JADX INFO: renamed from: ᛱᛲᛳᛴᛵᛶᛷᛸᤝᲈᲁᲀᲇᤞ */
