...
public final class ViewStubCompat extends View {
    ...
    public ViewStubCompat(Context context, AttributeSet attributeSet) {
        ...
        this.f190 = 0;
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, AbstractC2470.f7898, 0, 0);
    ...
    public void setOnInflateListener(InterfaceC3590 interfaceC3590) {
    }
}
