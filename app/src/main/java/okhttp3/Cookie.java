...
public final class Cookie {
    ...
    public static final class Builder {
        ...
        public final Builder name(String str) {
            if (!AbstractC2207.m4087(AbstractC2841.m4848(str).toString(), str)) {
        ...
        private final Builder domain(String str, boolean z) {
            ...
            if (canonicalHost == null) {
                throw new IllegalArgumentException(AbstractC2784.m4757("unexpected domain: ", str));
            }
    ...
    public static final class Companion {
        ...
        public final boolean domainMatch(String str, String str2) {
            return AbstractC2207.m4087(str, str2) || (str.endsWith(str2) && str.charAt((str.length() - str2.length()) - 1) == '.' && !Util.canParseAsIpAddress(str));
        }
        ...
        private final long parseExpires(String str, int i, int i2) {
            ...
            while (iDateCharacterOffset < i2) {
                ...
                } else if (iM4834 == -1 && matcher.usePattern(Cookie.MONTH_PATTERN).matches()) {
                    iM4834 = AbstractC2841.m4834(Cookie.MONTH_PATTERN.pattern(), matcher.group(1).toLowerCase(Locale.US), 0, false, 6) / 4;
            ...
            gregorianCalendar.set(2, iM4834 - 1);
        ...
        public final boolean pathMatch(HttpUrl httpUrl, String str) {
            ...
            if (AbstractC2207.m4087(strEncodedPath, str)) {
                return true;
            }
                ...
                if (strTrimSubstring$default.length() != 0 && Util.indexOfControlOrNonAscii(strTrimSubstring$default) == -1) {
                    ...
                    if (Util.indexOfControlOrNonAscii(strTrimSubstring) == -1) {
                        ...
                        while (i < length) {
                            ...
                            if (AbstractC2849.m4855(strTrimSubstring2, "expires")) {
                                try {
                                    expires = parseExpires(strTrimSubstring3, 0, strTrimSubstring3.length());
                                    z2 = true;
                                } catch (NumberFormatException | IllegalArgumentException unused) {
                                }
                            } else if (AbstractC2849.m4855(strTrimSubstring2, "max-age")) {
                                maxAge = parseMaxAge(strTrimSubstring3);
                                z2 = true;
                            } else if (AbstractC2849.m4855(strTrimSubstring2, "domain")) {
                                domain = parseDomain(strTrimSubstring3);
                                z4 = false;
                            } else if (AbstractC2849.m4855(strTrimSubstring2, "path")) {
                                strSubstring = strTrimSubstring3;
                            } else if (AbstractC2849.m4855(strTrimSubstring2, "secure")) {
                                z3 = true;
                            } else if (AbstractC2849.m4855(strTrimSubstring2, "httponly")) {
                                z = true;
                            }
                        ...
                        if (strSubstring == null || !strSubstring.startsWith("/")) {
                            String strEncodedPath = httpUrl.encodedPath();
                            int iM4838 = AbstractC2841.m4838(strEncodedPath, '/', 0, 6);
                            strSubstring = iM4838 != 0 ? strEncodedPath.substring(0, iM4838) : "/";
                        }
    ...
    public /* synthetic */ Cookie(String str, String str2, long j, String str3, String str4, boolean z, boolean z2, boolean z3, boolean z4, AbstractC0981 abstractC0981) {
    ...
    public boolean equals(Object obj) {
        ...
        return AbstractC2207.m4087(cookie.name, this.name) && AbstractC2207.m4087(cookie.value, this.value) && cookie.expiresAt == this.expiresAt && AbstractC2207.m4087(cookie.domain, this.domain) && AbstractC2207.m4087(cookie.path, this.path) && cookie.secure == this.secure && cookie.httpOnly == this.httpOnly && cookie.persistent == this.persistent && cookie.hostOnly == this.hostOnly;
    }
    ...
    public int hashCode() {
        return Boolean.hashCode(this.hostOnly) + ((Boolean.hashCode(this.persistent) + ((Boolean.hashCode(this.httpOnly) + ((Boolean.hashCode(this.secure) + AbstractC1194.m2775(AbstractC1194.m2775((Long.hashCode(this.expiresAt) + AbstractC1194.m2775(AbstractC1194.m2775(527, 31, this.name), 31, this.value)) * 31, 31, this.domain), 31, this.path)) * 31)) * 31)) * 31);
    }
    ...
    public final boolean matches(HttpUrl httpUrl) {
        if ((this.hostOnly ? AbstractC2207.m4087(httpUrl.host(), this.domain) : Companion.domainMatch(httpUrl.host(), this.domain)) && Companion.pathMatch(httpUrl, this.path)) {
