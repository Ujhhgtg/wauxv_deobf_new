...
public final class ConnectionSpec {
    ...
    static {
        ...
        Builder builderCipherSuites = new Builder(true).cipherSuites((CipherSuite[]) Arrays.copyOf(cipherSuiteArr, 9));
        TlsVersion tlsVersion = TlsVersion.TLS_1_3;
        TlsVersion tlsVersion2 = TlsVersion.TLS_1_2;
        RESTRICTED_TLS = builderCipherSuites.tlsVersions(TlsVersion.TLS_1_3, TlsVersion.TLS_1_2).supportsTlsExtensions(true).build();
    ...
    private final ConnectionSpec supportedSpec(SSLSocket sSLSocket, boolean z) {
        ...
        String[] strArrIntersect2 = this.tlsVersionsAsString != null ? Util.intersect(sSLSocket.getEnabledProtocols(), this.tlsVersionsAsString, C2120.f6980) : sSLSocket.getEnabledProtocols();
    ...
    public final boolean isCompatible(SSLSocket sSLSocket) {
        ...
        if (strArr != null && !Util.hasIntersection(strArr, sSLSocket.getEnabledProtocols(), C2120.f6980)) {
            return false;
        }
