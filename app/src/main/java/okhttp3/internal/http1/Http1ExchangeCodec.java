...
public final class Http1ExchangeCodec implements ExchangeCodec {
    ...
    /* JADX INFO: compiled from: obf */
    public abstract class AbstractSource implements InterfaceC2786 {
        private boolean closed;
        private final C1405 timeout;

        public AbstractSource() {
            this.timeout = new C1405(Http1ExchangeCodec.this.source.timeout());
        }
        ...
        public long read(C0504 c0504, long j) throws IOException {
            try {
                return Http1ExchangeCodec.this.source.read(c0504, j);
            } catch (IOException e) {
    ...
    /* JADX INFO: compiled from: obf */
    public final class ChunkedSink implements InterfaceC2713 {
        private boolean closed;
        private final C1405 timeout;

        public ChunkedSink() {
            this.timeout = new C1405(Http1ExchangeCodec.this.sink.timeout());
        }
        ...
        public synchronized void close() {
            ...
            this.closed = true;
            Http1ExchangeCodec.this.sink.mo1775("0\r\n\r\n");
            Http1ExchangeCodec.this.detachTimeout(this.timeout);
        ...
        public void write(C0504 c0504, long j) {
            ...
            Http1ExchangeCodec.this.sink.mo1779(j);
            Http1ExchangeCodec.this.sink.mo1775("\r\n");
            Http1ExchangeCodec.this.sink.write(c0504, j);
            Http1ExchangeCodec.this.sink.mo1775("\r\n");
        }
    }
    ...
    public final class ChunkedSource extends AbstractSource {
        ...
        private final void readChunkSize() throws ProtocolException {
            ...
            try {
                this.bytesRemainingInChunk = Http1ExchangeCodec.this.source.mo1792();
                String string = AbstractC2841.m4848(Http1ExchangeCodec.this.source.mo1783()).toString();
        ...
        @Override // okhttp3.internal.http1.Http1ExchangeCodec.AbstractSource, p000.InterfaceC2786
        public long read(C0504 c0504, long j) throws IOException {
            if (j < 0) {
    ...
    /* JADX INFO: compiled from: obf */
    public final class KnownLengthSink implements InterfaceC2713 {
        private boolean closed;
        private final C1405 timeout;
        ...
        public void write(C0504 c0504, long j) {
            ...
            Util.checkOffsetAndCount(c0504.f2172, 0L, j);
            Http1ExchangeCodec.this.sink.write(c0504, j);
        }
    }
    ...
    public Http1ExchangeCodec(OkHttpClient okHttpClient, RealConnection realConnection, InterfaceC0508 interfaceC0508, InterfaceC0507 interfaceC0507) {
        this.client = okHttpClient;
        this.connection = realConnection;
        this.source = interfaceC0508;
        this.sink = interfaceC0507;
        this.headersReader = new HeadersReader(interfaceC0508);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final void detachTimeout(C1405 c1405) {
        C3400 c3400 = c1405.f5064;
        c1405.f5064 = C3400.NONE;
        c3400.clearDeadline();
        c3400.clearTimeout();
    }
    ...
    private final InterfaceC2713 newChunkedSink() {
        if (this.state == 1) {
            this.state = 2;
    ...
    private final InterfaceC2786 newChunkedSource(HttpUrl httpUrl) {
        if (this.state == 4) {
            this.state = 5;
    ...
    private final InterfaceC2786 newFixedLengthSource(long j) {
        if (this.state == 4) {
            this.state = 5;
    ...
    private final InterfaceC2713 newKnownLengthSink() {
        if (this.state == 1) {
            this.state = 2;
    ...
    private final InterfaceC2786 newUnknownLengthSource() {
        if (this.state == 4) {
            this.state = 5;
    ...
    @Override // okhttp3.internal.http.ExchangeCodec
    public InterfaceC2713 createRequestBody(Request request, long j) throws ProtocolException {
    ...
    @Override // okhttp3.internal.http.ExchangeCodec
    public InterfaceC2786 openResponseBodySource(Response response) {
    ...
    public Response.Builder readResponseHeaders(boolean z) throws IOException {
        ...
        try {
            ...
            throw new IOException(AbstractC2784.m4757("unexpected end of stream on ", getConnection().route().address().url().redact()), e);
        }
    }
    ...
    public final void writeRequest(Headers headers, String str) {
        ...
        this.sink.mo1775(str).mo1775("\r\n");
        int size = headers.size();
        for (int i = 0; i < size; i++) {
            this.sink.mo1775(headers.name(i)).mo1775(": ").mo1775(headers.value(i)).mo1775("\r\n");
        }
        this.sink.mo1775("\r\n");
        this.state = 1;
    }
