...
public final class Jdk8WithJettyBootPlatform extends Platform {
    ...
    public static final class AlpnProvider implements InvocationHandler {
        ...
        public Object invoke(Object obj, Method method, Object[] objArr) {
            ...
            if (AbstractC2207.m4087(name, "supports") && AbstractC2207.m4087(Boolean.TYPE, returnType)) {
                return Boolean.TRUE;
            }
            if (AbstractC2207.m4087(name, "unsupported") && AbstractC2207.m4087(Void.TYPE, returnType)) {
                this.unsupported = true;
                return null;
            }
            if (AbstractC2207.m4087(name, "protocols") && objArr.length == 0) {
                return this.protocols;
            }
            if ((AbstractC2207.m4087(name, "selectProtocol") || AbstractC2207.m4087(name, "select")) && String.class.equals(returnType) && objArr.length == 1) {
            ...
            if ((!AbstractC2207.m4087(name, "protocolSelected") && !AbstractC2207.m4087(name, "selected")) || objArr.length != 1) {
