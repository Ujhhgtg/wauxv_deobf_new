...
public final class HostnamesKt {
    private static final boolean containsInvalidHostnameAsciiCodes(String str) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (AbstractC2207.m4089(cCharAt, 31) <= 0 || AbstractC2207.m4089(cCharAt, 127) >= 0 || AbstractC2841.m4833(cCharAt, 0, 6, " #%/:?@[\\]") != -1) {
                return true;
            }
        }
        return false;
    ...
    private static final boolean decodeIpv4Suffix(String str, int i, int i2, byte[] bArr, int i3) {
        ...
        while (i < i2) {
            ...
            while (i5 < i2) {
                ...
                if (AbstractC2207.m4089(cCharAt, 48) < 0 || AbstractC2207.m4089(cCharAt, 57) > 0) {
                    break;
                }
    ...
    private static final String inet6AddressToAscii(byte[] bArr) {
        ...
        while (i2 < bArr.length) {
            if (i2 == i) {
                ...
                c0504.m1798((Util.and(bArr[i2], 255) << 8) | Util.and(bArr[i2 + 1], 255));
                i2 += 2;
            }
        }
        return c0504.m1786();
    ...
    public static final String toCanonicalHost(String str) {
        if (!AbstractC2841.m4828(str, ":", false)) {
            try {
        ...
        throw new AssertionError(AbstractC2784.m4749("Invalid IPv6 address: '", str, '\''));
    }
}
