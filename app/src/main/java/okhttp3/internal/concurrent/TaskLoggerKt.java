...
public final class TaskLoggerKt {
    ...
    public static final <T> T logElapsed(Task task, TaskQueue taskQueue, InterfaceC1414 interfaceC1414) {
        long jNanoTime;
    ...
    public static final void taskLog(Task task, TaskQueue taskQueue, InterfaceC1414 interfaceC1414) {
        if (TaskRunner.Companion.getLogger().isLoggable(Level.FINE)) {
            log(task, taskQueue, (String) interfaceC1414.invoke());
        }
    }
}
