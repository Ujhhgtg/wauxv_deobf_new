...
public final class Http2Writer implements Closeable {
    ...
    private final C0504 hpackBuffer;
    ...
    public Http2Writer(InterfaceC0507 interfaceC0507, boolean z) {
        ...
        try {
            ...
            if (this.client) {
                ...
                if (logger2.isLoggable(Level.FINE)) {
                    logger2.fine(Util.format(">> CONNECTION " + Http2.CONNECTION_PREFACE.mo1871(), new Object[0]));
                }
                this.sink.mo1777(Http2.CONNECTION_PREFACE);
                this.sink.flush();
            }
        } catch (Throwable th) {
            throw th;
    ...
    public final synchronized void data(boolean z, int i, C0504 c0504, int i2) {
        if (this.closed) {
            throw new IOException("closed");
        }
        dataFrame(i, z ? 1 : 0, c0504, i2);
    }

    public final void dataFrame(int i, int i2, C0504 c0504, int i3) {
        frameHeader(i, i3, 0, i2);
        if (i3 > 0) {
            this.sink.write(c0504, i3);
        }
    }
