...
public final class Http2 {
    ...
    public static final C0539 CONNECTION_PREFACE;
    ...
    static {
        C0539 c0539 = new C0539("PRI * HTTP/2.0\r\n\r\nSM\r\n\r\n".getBytes(AbstractC0599.f2413));
        c0539.f2247 = "PRI * HTTP/2.0\r\n\r\nSM\r\n\r\n";
    ...
    public final String formatFlags(int i, int i2) {
        ...
        if (i != 2 && i != 3) {
            ...
            if (i != 7 && i != 8) {
                ...
                if (i != 5 || (i2 & 4) == 0) {
                    return (i != 0 || (i2 & 32) == 0) ? str : AbstractC2849.m4857(str, "PRIORITY", "COMPRESSED");
                }
                return AbstractC2849.m4857(str, "HEADERS", "PUSH_PROMISE");
            }
        }
        return BINARY[i2];
    }
