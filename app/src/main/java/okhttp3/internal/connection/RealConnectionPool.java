...
public final class RealConnectionPool {
    ...
    public RealConnectionPool(TaskRunner taskRunner, int i, long j, TimeUnit timeUnit) {
        ...
        final String strM4752 = AbstractC2784.m4752(new StringBuilder(), Util.okHttpName, " ConnectionPool");
        this.cleanupTask = new Task(strM4752) { // from class: okhttp3.internal.connection.RealConnectionPool$cleanupTask$1
        ...
        if (j <= 0) {
            throw new IllegalArgumentException(AbstractC2784.m4746(j, "keepAliveDuration <= 0: ").toString());
        }
    }
