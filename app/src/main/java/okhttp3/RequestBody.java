...
public abstract class RequestBody {
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ RequestBody create$default(Companion companion, C0539 c0539, MediaType mediaType, int i, Object obj) {
            if ((i & 1) != 0) {
                mediaType = null;
            }
        ...
        public final RequestBody create(final C0539 c0539, final MediaType mediaType) {
            return new RequestBody() { // from class: okhttp3.RequestBody$Companion$toRequestBody$1
                ...
                @Override // okhttp3.RequestBody
                public void writeTo(InterfaceC0507 interfaceC0507) {
                    interfaceC0507.mo1777(c0539);
                }
            };
        }
        ...
        public final RequestBody create(final byte[] bArr, final MediaType mediaType, final int i, final int i2) {
            ...
            return new RequestBody() { // from class: okhttp3.RequestBody$Companion$toRequestBody$2
                ...
                @Override // okhttp3.RequestBody
                public void writeTo(InterfaceC0507 interfaceC0507) {
                    interfaceC0507.mo1788(i, i2, bArr);
                }
            };
        }
        ...
        public final RequestBody create(final File file, final MediaType mediaType) {
            return new RequestBody() { // from class: okhttp3.RequestBody$Companion$asRequestBody$1
                ...
                @Override // okhttp3.RequestBody
                public void writeTo(InterfaceC0507 interfaceC0507) throws IOException {
                    File file2 = file;
                    Logger logger = AbstractC2273.f7371;
                    C0279 c0279 = new C0279(new FileInputStream(file2), 1, C3400.NONE);
                    try {
                        interfaceC0507.mo1769(c0279);
                        c0279.close();
                    } catch (Throwable th) {
                        try {
                            throw th;
                        } catch (Throwable th2) {
                            AbstractC1458.m3154(c0279, th);
                            throw th2;
                        }
                    }
                }
        ...
        public final RequestBody create(MediaType mediaType, C0539 c0539) {
    ...
    public static final RequestBody create(C0539 c0539, MediaType mediaType) {
        return Companion.create(c0539, mediaType);
    }
    ...
    public abstract void writeTo(InterfaceC0507 interfaceC0507);
    ...
    public static final RequestBody create(MediaType mediaType, C0539 c0539) {
