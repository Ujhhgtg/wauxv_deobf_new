...
public final class CacheControl {
    ...
    public static final class Builder {
        ...
        public final Builder maxAge(int i, TimeUnit timeUnit) {
            if (i < 0) {
                throw new IllegalArgumentException(AbstractC1194.m2779(i, "maxAge < 0: ").toString());
            }
        ...
        public final Builder maxStale(int i, TimeUnit timeUnit) {
            if (i < 0) {
                throw new IllegalArgumentException(AbstractC1194.m2779(i, "maxStale < 0: ").toString());
            }
        ...
        public final Builder minFresh(int i, TimeUnit timeUnit) {
            if (i < 0) {
                throw new IllegalArgumentException(AbstractC1194.m2779(i, "minFresh < 0: ").toString());
            }
    ...
    public static final class Companion {
        ...
        public final CacheControl parse(Headers headers) {
            ...
            while (i < size) {
                ...
                if (AbstractC2849.m4855(strName, "Cache-Control")) {
                    if (str == null) {
                        str = strValue;
                    }
                    iIndexOfElement = 0;
                    while (iIndexOfElement < strValue.length()) {
                        ...
                        string = AbstractC2841.m4848(strValue.substring(iIndexOfElement, iIndexOfElement2)).toString();
                        if (iIndexOfElement2 != strValue.length() || strValue.charAt(iIndexOfElement2) == ',' || strValue.charAt(iIndexOfElement2) == ';') {
                            ...
                            if (iIndexOfNonWhitespace >= strValue.length() || strValue.charAt(iIndexOfNonWhitespace) != '\"') {
                                ...
                                string2 = AbstractC2841.m4848(strValue.substring(iIndexOfNonWhitespace, iIndexOfElement)).toString();
                            } else {
                                int i2 = iIndexOfNonWhitespace + 1;
                                int iM4833 = AbstractC2841.m4833('\"', i2, 4, strValue);
                                string2 = strValue.substring(i2, iM4833);
                                iIndexOfElement = iM4833 + 1;
                            }
                        }
                    ...
                    if (AbstractC2849.m4855(strName, "Pragma")) {
                    }
                    i++;
                    headers2 = headers;
                }
    ...
    public /* synthetic */ CacheControl(boolean z, boolean z2, int i, int i2, boolean z3, boolean z4, boolean z5, int i3, int i4, boolean z6, boolean z7, boolean z8, String str, AbstractC0981 abstractC0981) {
