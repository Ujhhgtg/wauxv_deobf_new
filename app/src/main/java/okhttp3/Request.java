        ...
        public Builder method(String str, RequestBody requestBody) {
            ...
            if (requestBody == null) {
                if (HttpMethod.requiresRequestBody(str)) {
                    throw new IllegalArgumentException(AbstractC1194.m2785("method ", str, " must have a request body.").toString());
                }
            } else if (!HttpMethod.permitsRequestBody(str)) {
                throw new IllegalArgumentException(AbstractC1194.m2785("method ", str, " must not have a request body.").toString());
            }
            this.method = str;
    ...
    public String toString() {
        ...
        if (this.headers.size() != 0) {
            ...
            for (C2315 c2315 : this.headers) {
                ...
                C2315 c2316 = c2315;
                String str = (String) c2316.f7445;
                String str2 = (String) c2316.f7446;
                if (i > 0) {
                    sb.append(", ");
                }
                sb.append(str);
