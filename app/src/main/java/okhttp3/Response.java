...
public final class Response implements Closeable {
    ...
    public final ResponseBody peekBody(long j) throws EOFException {
        C2477 c2477Peek = this.body.source().peek();
        C0504 c0504 = new C0504();
        c2477Peek.mo1781(j);
        long jMin = Math.min(j, c2477Peek.f7914.f2172);
        while (jMin > 0) {
            long j2 = c2477Peek.read(c0504, jMin);
            if (j2 == -1) {
                throw new EOFException();
            }
            jMin -= j2;
        }
        return ResponseBody.Companion.create(c0504, this.body.contentType(), c0504.f2172);
    }
        ...
        private final void checkSupportResponse(String str, Response response) {
            if (response != null) {
                if (response.body() != null) {
                    throw new IllegalArgumentException(AbstractC2784.m4748(str, ".body != null").toString());
                }
                if (response.networkResponse() != null) {
                    throw new IllegalArgumentException(AbstractC2784.m4748(str, ".networkResponse != null").toString());
                }
                if (response.cacheResponse() != null) {
                    throw new IllegalArgumentException(AbstractC2784.m4748(str, ".cacheResponse != null").toString());
                }
                if (response.priorResponse() != null) {
                    throw new IllegalArgumentException(AbstractC2784.m4748(str, ".priorResponse != null").toString());
                }
            }
        }
