...
public abstract class AbstractC1328 extends AbstractC2209 {
    ...
    public static void m3042(File file, File file2) {
        ...
        if (file2.exists() && !file2.delete()) {
            throw new C1318(file, file2, "Tried to overwrite the destination, but failed to delete it.");
        }
        if (file.isDirectory()) {
            if (!file2.mkdirs()) {
                throw new C1327(file, file2, "Failed to create target directory.");
            }
            return;
        }
        ...
        try {
            ...
            try {
                ...
                AbstractC1458.m3154(fileInputStream, th3);
                throw th4;
            }
        }
    }
    ...
    public static void m3044(File file, String str) {
        ...
        try {
            m3045(fileOutputStream, str, charset);
            fileOutputStream.close();
        } catch (Throwable th) {
            try {
                throw th;
