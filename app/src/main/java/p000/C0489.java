...
public final class C0489 extends AbstractC0488 {
    ...
    public String toString() {
        switch (this.f2106) {
            case 0:
                return "Dir: " + this.f2105;
            case 1:
            default:
                return super.toString();
            case 2:
                return "Jrt: " + this.f2105;
        }
    }
    ...
    public final byte[] mo1723(String str) {
        switch (this.f2106) {
            case 0:
                File file = new File((File) this.f2105, str.replace('.', File.separatorChar) + ".class");
                if (!file.exists()) {
                    return null;
                }
                try {
            ...
            case 1:
                return (byte[]) this.f2105;
            default:
                try {
                    DataInputStream dataInputStream2 = new DataInputStream((InputStream) new URL(this.f2105 + ("/" + str.replace('.', '/') + ".class")).getContent());
                    try {
