...
public final class C2455 extends AbstractC2867 implements InterfaceC1582 {
    ...
    static {
        ...
        WeChatVersions enumC3677 = WeChatVersions.f11540;
        C1565 c1565 = C1565.f5440;
        
        if (C1565.m3278() > enumC3677.f11548 || C1565.m3280()) {
            WeChatVersionsPlay enumC3674 = WeChatVersionsPlay.f11503;
    ...
    public final void mo1232(DexKitBridge dexKitBridge) {
        if (f7800) {
            AbstractC1574.findMethod(C2453.f7794, dexKitBridge, new C2444(4));
            AbstractC1574.findMethod(C2454.f7795, dexKitBridge, new C2444(5));
        }
    }
    ...
    public final void mo1126() {
        if (f7800) {
            List listSingletonList = Collections.singletonList(AbstractC1574.dexToMethod(C2453.f7794));
            C2455 c2455 = f7796;
            C3689 c3689M4172 = C2309.createHook(c2455, listSingletonList);
            c2455.hookBefore(c3689M4172, new C2444(6));
