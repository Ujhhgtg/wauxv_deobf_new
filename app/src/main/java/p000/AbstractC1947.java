...
public abstract class AbstractC1947 implements InterfaceC2701, InterfaceC1955, AdapterView.OnItemClickListener {
    ...
    public final void onItemClick(AdapterView adapterView, View view, int i, long j) {
        ...
        (listAdapter instanceof HeaderViewListAdapter ? (C1941) ((HeaderViewListAdapter) listAdapter).getWrappedAdapter() : (C1941) listAdapter).f6400.m3769((MenuItem) listAdapter.getItem(i), this, !(this instanceof ViewOnKeyListenerC0572) ? 0 : 4);
    }
