...
public final class C2472 {
    ...
    public C2472(BigInteger bigInteger) {
        ...
        this.f7906 = bigIntegerArr4;
        this.f7907 = 255;
        BigInteger[] bigIntegerArr5 = this.f7905;
        BigInteger[] bigIntegerArr6 = this.f7903;
        BigInteger[] bigIntegerArr7 = this.f7904;
        bigIntegerArr7[0] = bigInteger;
        for (int i5 = 0; i5 < 4; i5++) {
            m4426(bigIntegerArr6);
        }
        C1661 c1661M4042 = AbstractC2203.m4042(AbstractC2203.m4044(0, bigIntegerArr7.length), 8);
        int i6 = c1661M4042.f5612;
        int i7 = c1661M4042.f5613;
        int i8 = c1661M4042.f5614;
        BigInteger bigInteger2 = f7902;
        ...
        C1661 c1661M4043 = AbstractC2203.m4042(AbstractC2203.m4044(0, bigIntegerArr5.length), 8);
        int i11 = c1661M4043.f5612;
        int i12 = c1661M4043.f5613;
        int i13 = c1661M4043.f5614;
