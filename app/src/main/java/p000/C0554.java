...
/* JADX INFO: renamed from: ᛱᛲᛳᛴᛵᛶᛷᛸᲇᤞᤝᲁᲈᲀ, reason: contains not printable characters */
/* JADX INFO: compiled from: obf */
/* JADX INFO: loaded from: classes.dex */
public final class C0554 {

    /* JADX INFO: renamed from: ᛱᛲᛳᛴᛵᛶᛷᛸᤝᤞᲀᲁᲇᲈ, reason: contains not printable characters */
    public final float f2273;

    /* JADX INFO: renamed from: ᛱᛲᛳᛴᛵᛶᛷᛸᤝᤞᲀᲁᲈᲇ, reason: contains not printable characters */
    public final float f2274;

    /* JADX INFO: renamed from: ᛱᛲᛳᛴᛵᛶᛷᛸᤝᤞᲀᲇᲁᲈ, reason: contains not printable characters */
    public final float f2275;

    /* JADX INFO: renamed from: ᛱᛲᛳᛴᛵᛶᛷᛸᤝᤞᲀᲇᲈᲁ, reason: contains not printable characters */
    public final float f2276;

    /* JADX INFO: renamed from: ᛱᛲᛳᛴᛵᛶᛷᛸᤝᤞᲀᲈᲁᲇ, reason: contains not printable characters */
    public final float f2277;

    /* JADX INFO: renamed from: ᛱᛲᛳᛴᛵᛶᛷᛸᤝᤞᲀᲈᲇᲁ, reason: contains not printable characters */
    public final float f2278;

    public C0554(float f, float f2, float f3, float f4, float f5, float f6) {
        this.f2273 = f;
        this.f2274 = f2;
        this.f2275 = f3;
        this.f2276 = f4;
    ...
    /* JADX INFO: renamed from: ᛱᛲᛳᛴᛵᛶᛷᛸᤝᤞᲀᲁᲇᲈ, reason: contains not printable characters */
    public static C0554 m1933(int i) {
        C3602 c3602 = C3602.f11237;
        float fM3164 = AbstractC1458.m3164(Color.red(i));
        float fM3165 = AbstractC1458.m3164(Color.green(i));
        float fM3166 = AbstractC1458.m3164(Color.blue(i));
        float[][] fArr = AbstractC1458.f5184;
        float[] fArr2 = fArr[0];
        float f = (fArr2[2] * fM3166) + (fArr2[1] * fM3165) + (fArr2[0] * fM3164);
        float[] fArr3 = fArr[1];
        float f2 = (fArr3[2] * fM3166) + (fArr3[1] * fM3165) + (fArr3[0] * fM3164);
        float[] fArr4 = fArr[2];
        float f3 = (fM3166 * fArr4[2]) + (fM3165 * fArr4[1]) + (fM3164 * fArr4[0]);
        float[][] fArr5 = AbstractC1458.f5181;
        float[] fArr6 = fArr5[0];
        ...
        float[] fArr9 = c3602.f11244;
        float f7 = c3602.f11246;
        float f8 = c3602.f11241;
        float f9 = c3602.f11238;
        float f10 = fArr9[0] * f4;
        float f11 = fArr9[1] * f5;
        float f12 = fArr9[2] * f6;
        float f13 = c3602.f11245;
        ...
        float fPow4 = ((float) Math.pow((f18 * c3602.f11239) / f9, c3602.f11247 * f8)) * 100.0f;
        Math.sqrt(fPow4 / 100.0f);
        float f20 = f9 + 4.0f;
        float fPow5 = ((float) Math.pow(1.64d - Math.pow(0.29d, c3602.f11243), 0.73d)) * ((float) Math.pow((((((((float) (Math.cos(((((double) (((double) fAtan2) < 20.14d ? 360.0f + fAtan2 : fAtan2)) * 3.141592653589793d) / 180.0d) + 2.0d) + 3.8d)) * 0.25f) * 3846.1538f) * c3602.f11242) * c3602.f11240) * ((float) Math.sqrt((f15 * f15) + (f14 * f14)))) / (f17 + 0.305f), 0.9d));
        ...
        double d2 = f19;
        return new C0554(fAtan2, fSqrt, fPow4, f21, fLog * ((float) Math.cos(d2)), fLog * ((float) Math.sin(d2)));
    }

    /* JADX INFO: renamed from: ᛱᛲᛳᛴᛵᛶᛷᛸᤝᤞᲀᲁᲈᲇ, reason: contains not printable characters */
    public static C0554 m1934(float f, float f2, float f3) {
        C3602 c3602 = C3602.f11237;
        float f4 = c3602.f11241;
        double d = ((double) f) / 100.0d;
        Math.sqrt(d);
        float f5 = c3602.f11238 + 4.0f;
        float f6 = c3602.f11246 * f2;
        Math.sqrt(((f2 / ((float) Math.sqrt(d))) * c3602.f11241) / f5);
        float f7 = (1.7f * f) / ((0.007f * f) + 1.0f);
        float fLog = ((float) Math.log((((double) f6) * 0.0228d) + 1.0d)) * 43.85965f;
        double d2 = (3.1415927f * f3) / 180.0f;
        return new C0554(f3, f2, f, f7, fLog * ((float) Math.cos(d2)), fLog * ((float) Math.sin(d2)));
    }

    /* JADX WARN: Code duplicated, block: B:8:0x001f  */
    /* JADX INFO: renamed from: ᛱᛲᛳᛴᛵᛶᛷᛸᤝᤞᲀᲇᲁᲈ, reason: contains not printable characters */
    public final int m1935(C3602 c3602) {
        float fSqrt;
        float f = this.f2274;
        double d = f;
        float f2 = this.f2275;
        ...
        float f3 = c3602.f11243;
        float f4 = c3602.f11245;
        float fPow = (float) Math.pow(((double) fSqrt) / Math.pow(1.64d - Math.pow(0.29d, f3), 0.73d), 1.1111111111111112d);
        double d3 = (this.f2273 * 3.1415927f) / 180.0f;
        float fCos = ((float) (Math.cos(2.0d + d3) + 3.8d)) * 0.25f;
        float fPow2 = c3602.f11238 * ((float) Math.pow(((double) f2) / 100.0d, (1.0d / ((double) c3602.f11241)) / ((double) c3602.f11247)));
        float f5 = fCos * 3846.1538f * c3602.f11242 * c3602.f11240;
        float f6 = fPow2 / c3602.f11239;
