...
public class C1133 implements InterfaceC0876, InterfaceC1997, InterfaceC2578, InterfaceC1954, InterfaceC1771 {
    ...
    public static void m2706(byte[] bArr, BigInteger bigInteger) {
        ...
        while (true) {
            ...
            while (i7 < 8) {
                ...
                "shiftRight(...)";
                BigInteger bigIntegerValueOf = BigInteger.valueOf(255);
                "valueOf(...)";
    ...
    public static void m2713(String str, List list) throws IllegalAccessException, InvocationTargetException {
        ...
        while (it.hasNext()) {
            ...
            Method methodM3315 = AbstractC1574.dexToMethod(C0809.f3171);
        ...
        c2171.getClass();
        C2180.addNetSceneToQueue(AbstractC1574.dexToCtor(C2170.f7131).newInstance(linkedList));
    }
    ...
    public static void m2718(String toUsername, String md5, String appId) throws JSONException, IllegalAccessException, InstantiationException, InvocationTargetException {
        String string;
        if (AbstractC3471.m5079(WeChatVersions.f11545) || AbstractC3471.m5080(WeChatVersionsPlay.f11510)) {
            String strM2264 = C0774.getSelfWxId();
            ImgUploadFeatureService$MethodSendImage c1617 = ImgUploadFeatureService$MethodSendImage.f5488;
            Method methodM3315 = AbstractC1574.dexToMethod(c1617);
            Class<?> paramsType = methodM3315.getParameterTypes()[0];
            C0796 c0796M3486 = AbstractC0968.startMethodResolution(paramsType).m3486();
            c0796M3486.f4485 = 5;
            Class<?>[] parameterTypes = ((C0798) AbstractC0744.firstInList(c0796M3486.m2344())).f3157.getParameterTypes();
            if (parameterTypes.length == 0) {
                throw new NoSuchElementException("Array is empty.");
            }
            Object crossParams = AbstractC0710.m2131(parameterTypes[parameterTypes.length - 1], new Object[0]);
            if (appId != null) {
            ...
            Object objM2133 = AbstractC0710.m2131(paramsType, new Object[]{md5, 1, strM2264, toUsername, crossParams});
            methodM3315.invoke(C2663.m4656(AbstractC1574.dexToMethod(c1617).getDeclaringClass()), objM2133);
            return;
        }
        C0774.f2874.getClass();
        String strM2265 = C0774.getSelfWxId();
        if (appId != null) {
        ...
        String str6 = string;
        C2180.addNetSceneToQueue(AbstractC1574.dexToCtor(C2194.f7155).newInstance(4, strM2265, toUsername, md5, 1, null, 0, str6, "", Boolean.TRUE, 0));
    }
    ...
    public static void m2719(String str, String str2, String str3, String str4, String str5, String str6) throws JSONException {
        ...
        c1732.f5830 = hashSet;
        c1732.f5831 = hashSet2;
        C2180.addNetSceneToQueue(C2173.m3959(c2173, str, c1732.toString(), EnumC3673.f11475.f11492));
    }
    ...
    public static void m2720(String str, String str2) throws IllegalAccessException, InstantiationException, InvocationTargetException {
        ...
        Constructor constructorM3314 = AbstractC1574.dexToCtor(C1621.f5494);
        ...
        Method methodM3315 = AbstractC1574.dexToMethod(c2609);
        if (Modifier.isStatic(methodM3315.getModifiers())) {
            methodM3315.invoke(null, thread, "ChattingUI_importMultiVideo");
            return;
        }
        C1299 c1299M3490 = AbstractC0968.startMethodResolution(AbstractC1574.dexToMethod(c2609).getDeclaringClass()).m3490();
        AbstractC0750.m2218(c1299M3490.f6372, (EnumC1999[]) Arrays.copyOf(new EnumC1999[]{EnumC1999.STATIC}, 1));
        c1299M3490.fieldType = AbstractC0270.m1385(AbstractC1574.dexToMethod(c2609).getDeclaringClass().getInterfaces());
        methodM3315.invoke(((C1315) AbstractC0744.firstInList(c1299M3490.resolve())).m3023(), thread, "ChattingUI_importMultiVideo");
    }
    ...
    public static void m2721(int i, String str, String str2) throws IllegalAccessException, InvocationTargetException {
        ...
        MethodResolver c1973M3492 = AbstractC0968.startMethodResolution(AbstractC1574.dexToClass(c3622)).m3492();
        c1973M3492.returnType = AbstractC2519.classToKClass(String.class);
        String str4 = (String) ((C1982) AbstractC2784.setParamsAndResolveFirstMethod(new Object[]{AbstractC2519.classToKClass(String.class), AbstractC2519.classToKClass(String.class)}, 2, c1973M3492)).invoke(str, "amr_");
        ...
        Method methodM3315 = AbstractC1574.dexToMethod(c3627);
        C2634.f8528.getClass();
        MethodResolver c1973M3494 = AbstractC0968.startMethodResolution(AbstractC1574.dexToClass(C2633.f8527)).m3492();
        c1973M3494.m3800(EnumC1999.STATIC);
        c1973M3494.returnType = AbstractC1574.dexToMethod(c3627).getDeclaringClass();
    ...
    public static void m2722(String str, String str2) {
        ...
        MethodResolver c1973M3492 = AbstractC0968.startMethodResolution(AbstractC1574.dexToClass(c0244)).m3492();
        EnumC1999 enumC1999 = EnumC1999.STATIC;
        c1973M3492.m3800(enumC1999);
        c1973M3492.returnType = AbstractC1574.dexToClass(c0244);
        Object objM3831 = ((C1982) AbstractC2784.setParamsAndResolveFirstMethod(new Object[]{AbstractC2519.classToKClass(String.class)}, 1, c1973M3492)).m3831(str2);
        C0247 c0247 = C0247.f1410;
        MethodResolver c1973M3493 = AbstractC0968.startMethodResolution(AbstractC1574.dexToMethod(C0246.f1409).getDeclaringClass()).m3492();
        c1973M3493.m3800(enumC1999);
        c1973M3493.returnType = AbstractC2519.classToKClass(Pair.class);
        ((C1982) AbstractC2784.setParamsAndResolveFirstMethod(new Object[]{AbstractC1574.dexToClass(c0244), AbstractC2519.classToKClass(String.class), AbstractC2519.classToKClass(String.class), AbstractC2519.classToKClass(String.class), AbstractC2519.classToKClass(String.class), AbstractC2519.classToKClass(byte[].class)}, 6, c1973M3493)).m3831(objM3831, "", "", str, "", null);
    }
    ...
    public static void m2726(String str, List list, String str2, String str3) throws IllegalAccessException, InvocationTargetException {
        ...
        while (it.hasNext()) {
            ...
            arrayList.add(AbstractC1574.dexToCtor(C2756.f8845).newInstance(str4, 2));
        }
        AbstractC1574.dexToMethod(C3511.f11013).invoke(objM5098, arrayList);
        if (str2 != null) {
            if (str2.length() == 0) {
                str2 = null;
            }
    ...
    public static void m2727(int i, String str, String str2, int i2) throws IllegalAccessException, NoSuchMethodException, InstantiationException, InvocationTargetException {
        ...
        c2200.getClass();
        Constructor constructorM3314 = AbstractC1574.dexToCtor(C2198.f7159);
        int parameterCount = constructorM3314.getParameterCount();
        if (parameterCount == 6) {
            objNewInstance = constructorM3314.newInstance(3, str, str2, Integer.valueOf(i), "", Integer.valueOf(i2));
        } else if (parameterCount == 7) {
            objNewInstance = constructorM3314.newInstance(3, str, str2, Integer.valueOf(i), "", Integer.valueOf(i2), null);
        } else {
            if (parameterCount != 8) {
                throw new NoSuchMethodException("With " + constructorM3314.getParameterCount() + " parameters not supported");
            }
            objNewInstance = constructorM3314.newInstance(3, str, str2, Integer.valueOf(i), "", Integer.valueOf(i2), null, null);
        }
        C2180.addNetSceneToQueue(objNewInstance);
    }
