...
public final class EnumC3676 {
    ...
    static {
        ...
        String str = "IMG";
        "图文";
        EnumC3676 enumC3676 = new EnumC3676(str, 0, 1);
        f11519 = enumC3676;
        String str2 = "TEXT";
        "文字";
        EnumC3676 enumC3677 = new EnumC3676(str2, 1, 2);
        f11520 = enumC3677;
        String str3 = "LINK";
        "链接";
        EnumC3676 enumC3678 = new EnumC3676(str3, 2, 3);
        f11521 = enumC3678;
        String str4 = "MUSIC";
        "音乐";
        EnumC3676 enumC3679 = new EnumC3676(str4, 3, 4);
        String str5 = "VIDEO";
        "视频";
        EnumC3676 enumC36710 = new EnumC3676(str5, 4, 5);
        String str6 = "COMMODITY";
        "商品";
        EnumC3676 enumC36711 = new EnumC3676(str6, 5, 9);
        String str7 = "STICKER";
        "表情包";
        EnumC3676 enumC36712 = new EnumC3676(str7, 6, 10);
        String str8 = "COMMODITY12";
        "商品12";
        EnumC3676 enumC36713 = new EnumC3676(str8, 7, 12);
        String str9 = "COUPON";
        "优惠券";
        EnumC3676 enumC36714 = new EnumC3676(str9, 8, 13);
        String str10 = "TV_SHOW";
        "电视剧";
        EnumC3676 enumC36715 = new EnumC3676(str10, 9, 14);
        String str11 = "LITTLE_VIDEO";
        "小视频";
        EnumC3676 enumC36716 = new EnumC3676(str11, 10, 15);
        f11522 = enumC36716;
        String str12 = "STREAM_VIDEO";
        "视频流";
        EnumC3676 enumC36717 = new EnumC3676(str12, 11, 18);
        String str13 = "ARTICLE_VIDEO";
        "文章视频";
        EnumC3676 enumC36718 = new EnumC3676(str13, 12, 19);
        String str14 = "NOTE";
        "笔记";
        EnumC3676 enumC36719 = new EnumC3676(str14, 13, 26);
        String str15 = "FINDER_VIDEO";
        "视频号";
        EnumC3676 enumC36720 = new EnumC3676(str15, 14, 28);
        f11523 = enumC36720;
        String str16 = "WE_APP_SINGLE_PAGE";
        "小程序";
        EnumC3676 enumC36721 = new EnumC3676(str16, 15, 30);
        String str17 = "LIVE";
        "直播";
        EnumC3676 enumC36722 = new EnumC3676(str17, 16, 34);
        String str18 = "FINDER_LONG_VIDEO";
        "长视频号";
        EnumC3676 enumC36723 = new EnumC3676(str18, 17, 36);
        String str19 = "LITE_APP";
        "轻应用";
        EnumC3676 enumC36724 = new EnumC3676(str19, 18, 41);
        String str20 = "RICH_MUSIC";
        "富音乐";
        EnumC3676 enumC36725 = new EnumC3676(str20, 19, 42);
        String str21 = "TING_AUDIO";
        "听音频";
        EnumC3676 enumC36726 = new EnumC3676(str21, 20, 47);
        String str22 = "LIVE_PHOTO";
        "实况";
        EnumC3676 enumC36727 = new EnumC3676(str22, 21, 54);
        f11524 = enumC36727;
