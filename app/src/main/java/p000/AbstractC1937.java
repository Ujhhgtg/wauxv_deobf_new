...
public abstract class AbstractC1937 {
    ...
    public static boolean m3736(Collection collection, List list, C1927 c1927) {
        if (collection.size() == list.size()) {
            ...
            for (Object obj : arrayList) {
                ...
                Class<C3529> clsM2183 = AbstractC0743.m2183(AbstractC2519.m4527(C3529.class));
    ...
    public static void m3749(AbstractC1928 abstractC1928, C1927 c1927) throws NoSuchFieldException, NoSuchMethodException {
        String strM3750;
        boolean z = abstractC1928 instanceof C1973;
        if (z) {
    ...
    public static Class m3751(Object obj, C1927 c1927, String str) {
        ...
        if (obj instanceof Class) {
            ...
            if (i == 1) {
                ...
                if (clsM2133 == null) {
                    ...
                    Class clsM2183 = AbstractC0743.m2183(AbstractC2519.m4527(clsM2133));
                    if (clsM2183 != null) {
                        clsM2133 = clsM2183;
                    }
                }
        ...
        Class<C3529> clsM2184 = AbstractC0743.m2183(AbstractC2519.m4527(C3529.class));
