...
public final class C1323feyxiexzfUjhhgtg extends AbstractC0255Ujhhgtgfeyxiexzf implements InterfaceC0745Ujhhgtgfeyxiexzf {
    ...
    public final void mo1830Ujhhgtgfeyxiexzf(C0578Ujhhgtgfeyxiexzf c0578Ujhhgtgfeyxiexzf, String str, ContentValues contentValues, String str2, String[] strArr, int i) throws IOException {
        ...
        if (str.equals(MagicFactory.get(4928545053141370250L, strArr2))) {
            String asString = contentValues.getAsString(MagicFactory.get(4928545014486664586L, strArr2));
            Integer asInteger = contentValues.getAsInteger(MagicFactory.get(4928545096091043210L, strArr2));
            String asString2 = contentValues.getAsString(MagicFactory.get(4928545181990389130L, strArr2));
            if (asString2 == null || AbstractC1152feyxiexzfUjhhgtg.m2631feyxiexzfUjhhgtg(asString2)) {
                return;
            }
            Set setM4256Ujhhgtgfeyxiexzf = AbstractC2856feyxiexzfUjhhgtg.m4256Ujhhgtgfeyxiexzf(AbstractC1152feyxiexzfUjhhgtg.m2638Ujhhgtgfeyxiexzf(asString2, new String[]{MagicFactory.get(4928545134745748874L, strArr2)}));
            ...
            Cursor cursor = (Cursor) ((C0393Ujhhgtgfeyxiexzf) AbstractC1225feyxiexzfUjhhgtg.m2698Ujhhgtgfeyxiexzf(new Object[]{AbstractC0959feyxiexzfUjhhgtg.m2443Ujhhgtgfeyxiexzf(String.class), AbstractC0959feyxiexzfUjhhgtg.m2443Ujhhgtgfeyxiexzf(Object[].class)}, 2, c0386UjhhgtgfeyxiexzfM2024Ujhhgtgfeyxiexzf)).m1650Ujhhgtgfeyxiexzf(MagicFactory.get(4928545263594767754L, strArr2), new Object[]{asString});
            if (cursor != null) {
                try {
                    if (cursor.moveToFirst()) {
                        int i3 = cursor.getInt(cursor.getColumnIndex(MagicFactory.get(4928544421781177738L, strArr2)));
                        if (i3 == 0) {
                            cursor.close();
                            return;
                        }
                        String string = cursor.getString(cursor.getColumnIndex(MagicFactory.get(4928544507680523658L, strArr2)));
                        if (string != null && !AbstractC1152feyxiexzfUjhhgtg.m2631feyxiexzfUjhhgtg(string)) {
                            Set setM4256Ujhhgtgfeyxiexzf2 = AbstractC2856feyxiexzfUjhhgtg.m4256Ujhhgtgfeyxiexzf(AbstractC1152feyxiexzfUjhhgtg.m2638Ujhhgtgfeyxiexzf(string, new String[]{MagicFactory.get(4928544460435883402L, strArr2)}));
                            if (asInteger.intValue() > i3) {
                                for (String str3 : AbstractC1106feyxiexzfUjhhgtg.m2575Ujhhgtgfeyxiexzf(setM4256Ujhhgtgfeyxiexzf, setM4256Ujhhgtgfeyxiexzf2)) {
                                    String str4 = MagicFactory.get(4928544451845948810L, strArr2);
                                    ...
                                    while (it.hasNext()) {
                                        ...
                                        if (c1435feyxiexzfUjhhgtgM2963Ujhhgtgfeyxiexzf != null) {
                                            c1435feyxiexzfUjhhgtgM2963Ujhhgtgfeyxiexzf.m2928Ujhhgtgfeyxiexzf(MagicFactory.get(4928463706460784010L, strArr2), str4, asString, str3, strM5373feyxiexzfUjhhgtg);
                                        }
                                    }
                                }
                                ...
                                for (String str5 : AbstractC1106feyxiexzfUjhhgtg.m2575Ujhhgtgfeyxiexzf(setM4256Ujhhgtgfeyxiexzf2, setM4256Ujhhgtgfeyxiexzf)) {
                                    String str6 = MagicFactory.get(4928544567810065802L, strArr2);
                                    C3681feyxiexzfUjhhgtg.f11704Ujhhgtgfeyxiexzf.getClass();
                                    ...
                                    while (it2.hasNext()) {
                                        ...
                                        if (c1435feyxiexzfUjhhgtgM2963Ujhhgtgfeyxiexzf2 != null) {
                                            c1435feyxiexzfUjhhgtgM2963Ujhhgtgfeyxiexzf2.m2928Ujhhgtgfeyxiexzf(MagicFactory.get(4928463706460784010L, strArr2), str6, asString, str5, strM5373feyxiexzfUjhhgtg2);
                                        }
                                    }
                                }
                            }
