...
public final class C1079 {
    ...
    public C1079(String str, int i, int i2) {
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof C1079) {
            return Objects.equals(this.f3898, ((C1079) obj).f3898);
        }
        return false;
    }

    public final int hashCode() {
        return Objects.hashCode(this.f3898);
    }

    public final String toString() {
        return this.f3898.toString();
    }
}
