...
public final class GroupData {
    ...
    public String toString() {
        ...
        sb.append(MagicFactory.get(4928294347310368138L, strArr));
        sb.append(this.roomId);
        sb.append(MagicFactory.get(4928294407439910282L, strArr));
        sb.append(this.memberIds);
        sb.append(MagicFactory.get(4928294489044288906L, strArr));
        sb.append(this.memberNames);
        sb.append(MagicFactory.get(4928294562058732938L, strArr));
        sb.append(this.memberCount);
        sb.append(MagicFactory.get(4928294635073176970L, strArr));
        sb.append(this.membersHash);
        sb.append(MagicFactory.get(4928294708087621002L, strArr));
        sb.append(this.mineRoomName);
        sb.append(MagicFactory.get(4928294776807097738L, strArr));
        sb.append(this.owner);
        sb.append(MagicFactory.get(4928294738152392074L, strArr));
        sb.append(this.notice);
        sb.append(MagicFactory.get(4928293733130044810L, strArr));
        sb.append(this.noticeEditor);
        sb.append(MagicFactory.get(4928293801849521546L, strArr));
