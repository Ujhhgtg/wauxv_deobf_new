...
public final class ContactLabelBean {
    ...
    public ContactLabelBean(Object obj) {
        ...
        c3442feyxiexzfUjhhgtgM2021Ujhhgtgfeyxiexzf.f1479Ujhhgtgfeyxiexzf = MagicFactory.get(4928305527110239626L, strArr);
        ...
        c3442feyxiexzfUjhhgtgM2021Ujhhgtgfeyxiexzf2.f1479Ujhhgtgfeyxiexzf = MagicFactory.get(4928305604419650954L, strArr);
    ...
    public String toString() {
        ...
        String[] strArr = AbstractC3590Ujhhgtgfeyxiexzf.f11170Ujhhgtgfeyxiexzf;
        jSONObject.put(MagicFactory.get(4928305673139127690L, strArr), Integer.valueOf(this.id));
        jSONObject.put(MagicFactory.get(4928305660254225802L, strArr), this.name);
