...
public class o {
    ...
    public class a {
        ...
        public a(o oVar, String str) {
            this.a = TextUtils.isEmpty(str) ? str : AbstractC2784.m4748(str, "_");
        }
        ...
        public void b(String str, long j) {
            a(AbstractC2784.m4752(new StringBuilder(), this.a, str), String.valueOf(j));
        }

        public long a(String str, long j) {
            String strM4752 = AbstractC2784.m4752(new StringBuilder(), this.a, str);
            String strValueOf = String.valueOf(j);
            try {
                if (n.c(e.a)) {
                    strValueOf = m.a().b.getString(strM4752, strValueOf);
                }
            } catch (Exception e) {
                e.printStackTrace();
            }
