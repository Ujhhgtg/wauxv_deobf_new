    ...
    static {
        ...
        if (JDKUtils.JVM_VERSION <= 8 || JDKUtils.ANDROID) {
            ...
            try {
                ...
                c0014 = (LongBiFunction) LambdaMetafactory.metafactory(lookupTrustedLookup, "multiplyHigh", MethodType.methodType(LongBiFunction.class), methodType, lookupTrustedLookup.findStatic(Math.class, "multiplyHigh", methodType), methodType).getTarget().invokeExact();
