...
public interface ValueFilter extends Filter {
    static ValueFilter compose(ValueFilter valueFilter, ValueFilter valueFilter2) {
        return new C3531(valueFilter2, 0, valueFilter);
    }
