...
public abstract class PropertyAccessorFactoryLambda extends PropertyAccessorFactory {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ char lambda$getChar$0(Method method, Object obj) {
        return (char) getInt(method).applyAsInt(obj);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ float lambda$getFloat$0(ToDoubleFunction toDoubleFunction, Object obj) {
        return (float) toDoubleFunction.applyAsDouble(obj);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ short lambda$getShort$0(Method method, Object obj) {
        return (short) getInt(method).applyAsInt(obj);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$setByte$0(Method method, Object obj, byte b) {
        setInt(method).accept(obj, b);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$setChar$0(Method method, Object obj, char c) {
        setInt(method).accept(obj, c);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ void lambda$setFloat$0(BiConsumer biConsumer, Object obj, float f) {
        biConsumer.accept(obj, Float.valueOf(f));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$setShort$0(Method method, Object obj, short s) {
    ...
    public ToByteFunction<Object> getByte(final Method method) {
        ...
        return new ToByteFunction() { // from class: ᛱᛲᛳᛴᛵᛶᛷᲀᤝᲇᲈᛸᲁᤞ
            @Override // com.alibaba.fastjson2.function.ToByteFunction
            public final byte applyAsByte(Object obj) {
                return this.f7706.lambda$getByte$0(method, obj);
            }
        };
    }
    ...
    public ToCharFunction<Object> getChar(final Method method) {
        ...
        return new ToCharFunction() { // from class: ᛱᛲᛳᛴᛵᛶᛷᲀᤝᲈᛸᤞᲁᲇ
            @Override // com.alibaba.fastjson2.function.ToCharFunction
            public final char applyAsChar(Object obj) {
                return this.f7715.lambda$getChar$0(method, obj);
            }
        };
    }
    ...
    public ToFloatFunction<Object> getFloat(Method method) {
        ...
        try {
            ...
            return new ToFloatFunction() { // from class: ᛱᛲᛳᛴᛵᛶᛷᲀᤝᲇᲈᲁᛸᤞ
                @Override // com.alibaba.fastjson2.function.ToFloatFunction
                public final float applyAsFloat(Object obj) {
                    return PropertyAccessorFactoryLambda.lambda$getFloat$0(toDoubleFunctionInvokeExact, obj);
                }
            };
        } catch (Throwable th) {
            throw new RuntimeException("Failed to create lambda for method: " + method, th);
    ...
    public ToShortFunction<Object> getShort(final Method method) {
        ...
        return new ToShortFunction() { // from class: ᛱᛲᛳᛴᛵᛶᛷᲀᤝᲇᲈᲁᤞᛸ
            @Override // com.alibaba.fastjson2.function.ToShortFunction
            public final short applyAsShort(Object obj) {
                return this.f7713.lambda$getShort$0(method, obj);
            }
        };
    }
    ...
    public ObjBoolConsumer setBoolean(Method method) {
        ...
        try {
            ...
            Class cls = Void.TYPE;
            return new C1309(1, (BiConsumer) LambdaMetafactory.metafactory(lookup, "accept", methodType, MethodType.methodType(cls, Object.class, Object.class), methodHandleUnreflect, MethodType.methodType(cls, method.getDeclaringClass(), Boolean.class)).getTarget().invokeExact());
        } catch (Throwable th) {
            throw new RuntimeException("Failed to create lambda for method: " + method, th);
        }
    }
    ...
    public ObjFloatConsumer setFloat(Method method) {
        ...
        try {
            ...
            MethodType methodType = MethodType.methodType(BiConsumer.class);
            Class cls = Void.TYPE;
            return new C1312(1, (BiConsumer) LambdaMetafactory.metafactory(lookup, "accept", methodType, MethodType.methodType(cls, Object.class, Object.class), methodHandleUnreflect, MethodType.methodType(cls, method.getDeclaringClass(), Float.class)).getTarget().invokeExact());
        } catch (Throwable th) {
            throw new RuntimeException("Failed to create lambda for method: " + method, th);
        }
    }
    ...
    public BiConsumer<Object, Object> setObject(final String str, Method method) {
        ...
        if (length == 2 && parameterTypes[0].equals(String.class)) {
            try {
                ...
                return new BiConsumer() { // from class: ᛱᛲᛳᛴᛵᛶᛷᲀᤝᲇᲈᤞᛸᲁ
