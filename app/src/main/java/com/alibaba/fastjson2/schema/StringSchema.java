...
public final class StringSchema extends JSONSchema {
    ...
    public StringSchema(JSONObject jSONObject) {
        ...
        switch (string2) {
            case "duration":
                this.formatValidator = new C0335(16);
                break;
            case "date-time":
                this.formatValidator = new C0335(13);
                break;
            case "uri":
                this.formatValidator = new C0335(12);
                break;
            case "date":
                this.formatValidator = new C0335(14);
                break;
            case "ipv4":
                this.formatValidator = new C0335(10);
                break;
            case "ipv6":
                this.formatValidator = new C0335(11);
                break;
            case "time":
                this.formatValidator = new C0335(15);
                break;
            case "uuid":
                this.formatValidator = new C0335(17);
                break;
            case "email":
                this.formatValidator = new C0335(9);
                break;
            default:
                this.formatValidator = null;
                break;
