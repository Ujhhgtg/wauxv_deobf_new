...
public final class JSONKt {
    ...
    public static /* synthetic */ void parseObject$default(Reader reader, char c, InterfaceC1425 interfaceC1425, int i, Object obj) {
        if ((i & 1) != 0) {
            c = '\n';
        }
        JSON.parseObject(reader, c, Object.class, new JSONKt$sam$i$java_util_function_Consumer$0(interfaceC1425));
    }
    ...
    public static /* synthetic */ void parseObject$default(InputStream inputStream, Charset charset, char c, JSONReader.Feature[] featureArr, InterfaceC1425 interfaceC1425, int i, Object obj) {
        if ((i & 2) != 0) {
            c = '\n';
        }
        JSON.parseObject(inputStream, charset, c, Object.class, new JSONKt$sam$i$java_util_function_Consumer$0(interfaceC1425), (JSONReader.Feature[]) Arrays.copyOf(featureArr, featureArr.length));
    }
