...
public final class ASMUtils {
    ...
    static {
        ...
        DESC_FIELD_WRITER_ARRAY = AbstractC2784.m4757("[", str);
        String str2 = "L" + FieldReader.class.getName().replace('.', '/') + ';';
        DESC_FIELD_READER = str2;
        DESC_FIELD_READER_ARRAY = AbstractC2784.m4757("[", str2);
        DESC_JSON_READER = AbstractC2784.m4749("L", strReplace, ';');
        DESC_JSON_WRITER = AbstractC2784.m4749("L", strReplace5, ';');
        DESC_OBJECT_READER = AbstractC2784.m4749("L", strReplace2, ';');
        DESC_OBJECT_READER_ADAPTER = AbstractC2784.m4749("L", strReplace3, ';');
        DESC_OBJECT_WRITER = AbstractC2784.m4749("L", strReplace4, ';');
    ...
    public static String[] lookupParameterNames(AccessibleObject accessibleObject) {
        ...
        while (i < parameterCount) {
            strArr3[i] = AbstractC1194.m2779(i, "arg");
            i++;
        }
        return strArr3;
    }
