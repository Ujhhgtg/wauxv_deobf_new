...
public class UMLogCommon {
    ...
    public static final String SC_10001 = AbstractC2668.m4678(new StringBuilder("不能在非主进程进行初始化|目前只能在主进程进行初始化，如何正确初始化请详见地址："), "67292");
    public static final String SC_10002 = AbstractC2668.m4678(new StringBuilder("不能在非Application的onCreate方法中进行初始化|目前只能在Application的onCreate方法中进行初始化，如何正确初始化请详见地址："), "67292");
    public static final String SC_10007 = AbstractC2668.m4678(new StringBuilder("AppKey不能为空|您必须正确设置AppKey，如何正确初始化请详见地址："), "67292");
}
