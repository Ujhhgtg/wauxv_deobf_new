...
public class a implements UMImprintChangeCallback {
    ...
    private static FileObserverC0036a i = null;
    ...
    public a(Context context, Handler handler) {
        ...
        try {
            if (a == null) {
                ...
                handlerThread.start();
                if (i == null) {
                    FileObserverC0036a fileObserverC0036a = new FileObserverC0036a(UMFrUtils.getEnvelopeDirPath(context));
                    i = fileObserverC0036a;
